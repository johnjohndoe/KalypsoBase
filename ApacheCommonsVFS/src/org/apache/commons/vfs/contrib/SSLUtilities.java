...
/**
 * This class should help configuring a http client with ssl capabilities.<br>
 * <br>
 * <strong>Note:</strong> <br>
 * This is the implementation for the http client of ApacheCommensVFS.
 * ApacheCommonsVFS uses the HttpClient 2.
 * 
...
public class SSLUtilities {
	...
	/**
	 * This function will register a the https protocol, which will accept all
	 * certificates.<br>
