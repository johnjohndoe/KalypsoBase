...
/**
 * represents a url that embedds a command and can be executed
 * 
 * @author kuepfer
 */
public interface ICommandURL
{

  /**
   * Executes whatever valid commandURL is embedded in this URL. Returns true if action succeeded, and false otherwise.
   * 
   * @param context
   *          context of this CommandURL
   * @param listener
   *          a listener to pass any Event to the underlying
   * @see CommandLocationListener
   */
