...
public final class StatusUtilities
{
  ...
  /**
   * generates MultiStatus to make sure that each line of the message can be
   * seen as a single line in an errorDialog. Severety, pluginId and code remain
   * the same for each Status in the MultiStatus.
   * 
   * @param throwable
   */
  public static MultiStatus createMultiStatusFromMessage( final int severity,
      final String pluginId, final int code, final String message, final String delim,
