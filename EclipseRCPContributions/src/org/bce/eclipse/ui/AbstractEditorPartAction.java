...
/**
 * Default implementation of {@link org.bce.eclipse.ui.IEditorPartAction}. Just stores a reference
 * to the given editor.
 * 
 * @author Belger
 */
public abstract class AbstractEditorPartAction extends Action implements IEditorPartAction
{
  ...
  /**
   * @see org.bce.eclipse.ui.IEditorPartAction#setEditorPart(org.eclipse.ui.IEditorPart)
   */
