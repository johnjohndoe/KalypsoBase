...
/**
 * Utilities in relation to the {@link org.eclipse.core.runtime.IExtensionRegistry}.
 * 
...
public class ExtensionUtilities
{
  ...
  public static Map<String, IConfigurationElement> getConfigurationElements( final String extensionPointId, final String keyAttribute )
  {
    ...
    final Map<String, IConfigurationElement> result = new HashMap<String, IConfigurationElement>( configurationElements.length );

    for( final IConfigurationElement element : configurationElements )
    {
      final String key = element.getAttribute( keyAttribute );
