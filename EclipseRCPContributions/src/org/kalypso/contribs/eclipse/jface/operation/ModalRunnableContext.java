...
/**
 * A simplistic {@link IRunnableContext} implementation on {@link ModalContext}.
 * 
 * @author Gernot Belger
 */
public class ModalRunnableContext implements IRunnableContext
{
  private final IProgressMonitor m_monitor;

  private final Display m_display;

  public ModalRunnableContext( final IProgressMonitor monitor, final Display display )
  {
    m_monitor = monitor;
    m_display = display;
  }
