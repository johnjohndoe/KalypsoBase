...
/**
 * Reuseable action that collapses all tree items of a {@link TreeViewer}.
 * 
 * @author Gernot Belger
 */
public class CollapseAllTreeItemsAction extends Action
{
  private final ITreeViewerProvider m_provider;

  public CollapseAllTreeItemsAction( final TreeViewer viewer )
  {
    this( new DefaultTreeViewerProvider( viewer ) );
  }

  public CollapseAllTreeItemsAction( final ITreeViewerProvider provider )
  {
    m_provider = provider;
