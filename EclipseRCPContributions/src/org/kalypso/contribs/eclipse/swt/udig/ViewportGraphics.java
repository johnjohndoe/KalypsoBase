...
/**
 * An adapter that allows uDig and plugin writers to write to AWT components and images or SWT Drawable objects by using
...
public interface ViewportGraphics
{
   ...
   * <p>
   * Reference description from Graphics2d: <bq> Fills the interior of a <code>Shape</code> using the settings of the
   * <code>Graphics2D</code> context. The rendering attributes applied include the <code>Clip</code>,
   * <code>Transform</code>, <code>Paint</code>, and <code>Composite</code>.
   * 
   * @param s
   *          the <code>Shape</code> to be filled <bq>
   *          </p>
   * @param s
   ...
   * 
   * @param x
   *          The starting corner's x-coordinate.
   * @param y
   *          The starting corner's y-coordinate.
   * @param width
   *          the width of the rectangle
   * @param height
   *          the height of the rectangle
   ...
   * <p>
   * Reference description from Graphics2d: <bq> Strokes the outline of a <code>Shape</code> using the settings of the
   * current <code>Graphics2D</code> context. The rendering attributes applied include the <code>Clip</code>,
   * <code>Transform</code>, <code>Paint</code>, <code>Composite</code> and <code>Stroke</code> attributes. <bq>
   * </p>
   * 
   * @param s
   *          the <code>Shape</code> to be rendered
   ...
   *          The string to draw.
   * @param x
   *          the x coordinate of the location where the of the string will be placed.
   * @param y
   *          the y coordinate of the location where the of the string will be placed.
   * @param alignx
   *          horizontal alignment, {@link #ALIGN_LEFT}, {@link #ALIGN_MIDDLE} or {@link #ALIGN_RIGHT}
   * @param aligny
   *          vertical alignment, {@link #ALIGN_BOTTOM}, {@link #ALIGN_MIDDLE} or {@link #ALIGN_TOP}
   */
   ...
   * @param strokeWidth
   *          the width, in pixels, to draw lines with.
   */
   ...
   * 
   * @param offset
   *          The amount the draw is offset in the graphics.
   */
   ...
   *          The image to draw.
   * @param x
   *          The x coordinate of the image top left corner of the image.
   * @param y
   *          The y coordinate of the image top left corner of the image.
   */
  ...
  /**
   * Copies a rectangular area from the source image into a (potentially different sized) rectangular area in the
   * receiver. If the source and destination areas are of differing sizes, then the source area will be stretched or
   * shrunk to fit the destination area as it is copied. The copy fails if any part of the source rectangle lies outside
   * the bounds of the source image, or if any of the width or height arguments are negative.
   * 
   * @param image
   *          the source image
   * @param dx1
   ...
   * 
   * @param image
   *          The {@link org.eclipse.swt.graphics.Image} to draw.
   * @param x
   *          The x coordinate of the image top left corner of the image.
   * @param y
   *          The y coordinate of the image top left corner of the image.
  ...
  /**
   * Modifies the graphics so that further draws us minX,minY as the origin and maxX and maxY as the width and height of
   * the display area.
   * 
   * @param minX
   *          The x-coord that will be used as the origin.
   * @param minY
   *          The y-coord that will be used as the origin.
   * @param width
   *          The width that will be used to draws.
   * @param height
   *          The height that will be used to draws.
   */
  public void setTransform( AffineTransform transform );

  /**
   * Gets the height of the current font TODO at some point maybe this could be broken out to getFontMetrics(), and a
   * create FontMetrics object that maps between SWT and AWT.
   * 
  ...
  /**
   * Gets the <code>ascent</code> of the current font, which is the distance the font rises above its
   * <code>baseline</code>.
   * 
   * @return
   */
   ...
   * <p>
   * Please note this is a change in behaviour over AWT (where size is documented to be in 72 dpi. They are changing
   * their mind in later versions of java but we cannot wait for them to get there act together.
   * <p>
   * 
   * @param the
   *          font new font
  ...
  /**
   * Get the dots per inch, used to scale fonts, but you can scale anything you want based on this value (for example a
   * scalebar).
   * 
   * @param dpi
   */
   ...
   *          the height of the rectangle
   * @param startColor
   *          the first color used in the gradient paint
   * @param endColor
   *          the last color used in the gradient paint
   * @param isVertical
