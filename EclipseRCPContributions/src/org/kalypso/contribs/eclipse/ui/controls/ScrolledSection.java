...
public class ScrolledSection
{
  ...
  public Composite setup( final String title )
  {
    return setup( title, new GridData( GridData.FILL, GridData.FILL, true, true ), new GridData( GridData.FILL, GridData.FILL, true, true ) );
  }
}
