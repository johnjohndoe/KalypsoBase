...
public class GenericWizardRegistry extends AbstractExtensionWizardRegistry
{
  private final String m_extensionPointId;

  private final String m_pluginId;

  public GenericWizardRegistry( final String pluginId, final String extensionPointId )
  {
    m_pluginId = pluginId;
