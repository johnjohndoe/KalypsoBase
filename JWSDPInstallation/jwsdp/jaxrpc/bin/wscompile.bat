...
rem
rem $Id: wscompile.bat,v 1.6 2004/03/30 23:28:22 ofung Exp $
rem ---------------------------------------------------------------------------
...
"%JAVA_HOME%\bin\java.exe" -classpath %PRG%\..;%PRG%\..\..\..\jwsdp-shared\bin;"%PATH%" LauncherBootstrap -verbose wscompile %CMD_LINE_ARGS%
