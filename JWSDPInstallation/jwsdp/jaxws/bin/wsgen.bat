...
:LAUNCH
%JAVA% %WSGEN_OPTS% -cp %JAXWS_HOME%\lib\jaxws-tools.jar;%JAXWS_HOME%\lib\jaxws-rt.jar;%JAXWS_HOME%\..\sjsxp\lib\sjsxp.jar;%JAXWS_HOME%\..\jaxb\lib\jaxb-xjc.jar;%JAXWS_HOME%\..\jwsdp-shared\lib\relaxngDatatype.jar;%JAXWS_HOME%\..\jwsdp-shared\lib\resolver.jar com.sun.tools.ws.WsGen %*
