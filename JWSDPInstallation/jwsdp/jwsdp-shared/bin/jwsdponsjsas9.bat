...
rem as build file
"%JAVA_HOME%\bin\java.exe"  -Djava.endorsed.dirs="%JWSDP_HOME%\jaxp\lib;%JWSDP_HOME%\jaxp\lib\endorsed" -classpath "%JWSDP_HOME%\jwsdp-shared\bin;%JWSDP_HOME%\jwsdp-shared\bin\commons-launcher.jar;%JWSDP_HOME%\apache-ant\lib\ant.jar;%JWSDP_HOME%\apache-ant\lib\ant-launcher.jar;%JWSDP_HOME%\apache-ant\lib\ant-nodeps.jar;%JWSDP_HOME%\jaxp\lib\jaxp-api.jar;%JWSDP_HOME%\jaxp\lib\endorsed\sax.jar;%JWSDP_HOME%\jaxp\lib\endorsed\dom.jar;%JWSDP_HOME%\jaxp\lib\endorsed\xercesImpl.jar;%JWSDP_HOME%\jaxp\lib\endorsed\xalan.jar" LauncherBootstrap -verbose ant -buildfile "%JWSDP_HOME%\jwsdp-shared\bin\jwsdponsjsas9.xml"  -Dsjsas.home="%APPSERVER_HOME%" %CMD_LINE_ARGS% 
