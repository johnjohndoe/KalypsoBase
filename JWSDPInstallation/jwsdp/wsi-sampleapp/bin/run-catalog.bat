...
rem
rem $Id: run-catalog.bat,v 1.1 2004/03/24 03:27:28 arung Exp $
rem ---------------------------------------------------------------------------
...
"%JAVA_HOME%\bin\java.exe" -classpath %PRG%\..;%PRG%\..\..\..\jwsdp-shared\bin;"%PATH%" LauncherBootstrap -verbose wsi-catalog-client %CMD_LINE_ARGS%
