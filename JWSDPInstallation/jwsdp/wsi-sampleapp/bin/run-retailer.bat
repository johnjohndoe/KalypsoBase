...
rem
rem $Id: run-retailer.bat,v 1.3 2003/05/19 23:48:01 arung Exp $
rem ---------------------------------------------------------------------------
...
"%JAVA_HOME%\bin\java.exe" -classpath %PRG%\..;%PRG%\..\..\..\jwsdp-shared\bin;"%PATH%" LauncherBootstrap -verbose wsi-retailer-client %CMD_LINE_ARGS%
