...
/*
 * Implementation of interop scenario # 3 client.
 *
 * @author Kumar Jayanti (vbkumar.jayanti@sun.com)
 */ 
public class Scenario3Client {    
    ...
    private static QName portName =
        new QName("http://xmlsoap.org/Ping", "Ping3");

    
    private static void scenario3(PingService service) throws Exception {
        try {
    ...
    public static void main(String[] args) throws Exception {    
        ...
        String serviceURLFragment = System.getProperty("scenario3.service.url");        
        String serviceURL =
        ...
        scenario3(pingService);     
        // use static stubs to override endpoint property of WSDL       
        PingPort_Ping3_Stub stub = (PingPort_Ping3_Stub)  
                    (pingService.getPing3());           

        stub._setProperty(  
            javax.xml.rpc.Stub.ENDPOINT_ADDRESS_PROPERTY, serviceURL);  

        stub.ping(new TicketType("Id", "SUNW"), "Sun Microsystems says hello scenario 3!");
    ...
    protected static SecurityEnvironment initializeSecurityEnvironment()
        ...
        // ------------------ Mutual Agreements ---------------------
        // Certvalue in scenario 3 is Receiver's Certificate
        ...
        // set the agreement CERT-VALUE for scenario 3
