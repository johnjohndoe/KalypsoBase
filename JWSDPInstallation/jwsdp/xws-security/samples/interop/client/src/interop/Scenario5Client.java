...
/*
 * Implementation of interop scenario # 5 client.
 *
 * Note: we are using a single certificate instead of 2 for the double
 * signing operation in this scenario
 * @author Kumar Jayanti (vbkumar.jayanti@sun.com)
 */ 
public class Scenario5Client {    
    ...
    private static QName portName =
        new QName("http://xmlsoap.org/Ping", "Ping5");

    
    private static void scenario5(PingService service) throws Exception {
        try {
            ...
            secCfg.addXPathNamespace("ns0", "http://xmlsoap.org/Ping");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serviceURLFragment = System.getProperty("scenario5.service.url");        
        String serviceURL =
        ...
        scenario5(pingService);     
        // use static stubs to override endpoint property of WSDL       
        PingPort_Ping5_Stub stub = (PingPort_Ping5_Stub)  
                    (pingService.getPing5());           

        stub._setProperty(  
            javax.xml.rpc.Stub.ENDPOINT_ADDRESS_PROPERTY, serviceURL);

        stub.ping(new TicketType("Id", "SUNW"), "Sun Microsystems says hello scenario 5!");
    ...
    protected static SecurityEnvironment initializeSecurityEnvironment()
        ...
        // ------------------ Mutual Agreements ---------------------
        // Certvalue in scenario 5 is sender's certificate
        ...
        // set the agreement CERT-VALUE for scenario 5
