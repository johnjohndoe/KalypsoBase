...
/*
 * Implementation of interop scenario # 6 client.
 *
 * @author Kumar Jayanti (vbkumar.jayanti@sun.com)
 */ 
public class Scenario6Client {    
    ...
    private static QName portName =
        new QName("http://xmlsoap.org/Ping", "Ping6");

    
    private static void scenario6(PingService service) throws Exception {
        try {
    ...
    public static void main(String[] args) throws Exception {    
        ...
        String serviceURLFragment = System.getProperty("scenario6.service.url");        
        String serviceURL =
        ...
        scenario6(pingService);     
        // use static stubs to override endpoint property of WSDL       
        PingPort_Ping6_Stub stub = (PingPort_Ping6_Stub)  
                    (pingService.getPing6());           

        stub._setProperty(  
            javax.xml.rpc.Stub.ENDPOINT_ADDRESS_PROPERTY,  serviceURL);

        stub.ping(new TicketType("Id", "SUNW"), "Sun Microsystems says hello scenario 6!");
    ...
    protected static SecurityEnvironment initializeSecurityEnvironment()
        ...
        // ------------------ Mutual Agreements ---------------------
        // Scenario 6 certvalue is receiver's Cert
        ...
        // set the agreement CERT-VALUE for scenario 6
