 ...
 * as defined in the WSS interop spec Scenario # 4.
 *
 ...
 *
 */
public class Scenario4Impl extends interop.PingImpl {
    ...
    /*
     * Sign and Encrypt the message, WSS Scenario 4
     */
    private void scenario4() throws ServiceException {
        try {
            ...
            /* Configure filters for Outgoing messages */
