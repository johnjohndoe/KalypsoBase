 ...
 * as defined in the WSS interop spec Scenario # 6.
 *
 ...
 *
 */
public class Scenario6Impl extends interop.PingImpl {
    ...
    /*
     * Sign and Encrypt the message, WSS Scenario 6
     */
    private void scenario6() throws ServiceException {
        try {
