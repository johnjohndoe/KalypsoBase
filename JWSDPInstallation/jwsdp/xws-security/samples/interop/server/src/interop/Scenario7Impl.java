 ...
 * as defined in the WSS interop spec Scenario # 7.
 *
 ...
 *
 */
public class Scenario7Impl extends interop.PingImpl {
     ...
     *  WSS Scenario 7
     */
    private void scenario7() throws ServiceException {
        try {
            ...
            secCfg.addFilterForOutgoingMessages(
                new ExportEncryptedKeyFilter(new DirectReferenceStrategy(encrCert)));
