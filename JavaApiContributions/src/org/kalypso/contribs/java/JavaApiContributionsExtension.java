 ...
 * @author kuepfer
 */
public class JavaApiContributionsExtension
{
  private final static String URL_CATALOG_EXTENSION_POINT = "org.kalypso.contribs.java.urlCatalog";

  private static Map<Object, IUrlCatalog> m_catalogs;

  private static synchronized void initRegistry( )
  {
    m_catalogs = new HashMap<>();
