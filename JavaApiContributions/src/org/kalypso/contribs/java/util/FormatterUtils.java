...
/**
 * Helper methods for support of {@link java.util.Formatter}.
 * 
...
public class FormatterUtils
{
  ...
  /**
   * Checks, if an {@link IOException} has occurred within the given formatter.<br>
  ...
  {
    final IOException ioException = format.ioException();
    if( ioException == null )
      return;
