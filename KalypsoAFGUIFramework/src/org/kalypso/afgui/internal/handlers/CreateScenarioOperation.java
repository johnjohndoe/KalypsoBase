 ...
 */
public class CreateScenarioOperation implements IScenarioOperation
{
  private ScenarioData m_data;

  private IScenario m_scenario;
  ...
  public IStatus execute( final IProgressMonitor monitor ) throws CoreException
  {
    ...
    final boolean copySubScenarios = m_data.getCopySubScenarios();
    ...
    m_scenario = scenarioManager.createScenario( parentScenario, name, comment, templateScenario, copySubScenarios, monitor );
