...
public class TextThemeWizardPage extends WizardPage
{
  ...
  public void createControl( final Composite parent )
  {
    ...
    {
      @Override
      public void textPropertyChanged( final Properties properties, final int horizontal, final int vertical, final RGB background, final String text, final int fontSize, final boolean transparency )
      {
