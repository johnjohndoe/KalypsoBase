...
public class ThemeNameWizardPage extends WizardPage
{
  ...
  public ThemeNameWizardPage( final String pageName, final String title, final ImageDescriptor titleImage, final String themeName )
  {
