...
/**
 * A scenario in Kalypso allows the user to modify the normal course of operations within the GUI. The differences are
 * scenario-dependent and implementations are usually localised within components that react on these scenarios.
 * 
 * @author schlienger
 */
