...
public class ExportableObservationTable implements IExportableObject
{
  ...
  public IStatus exportObject( final OutputStream output, final IProgressMonitor monitor )
  {
    ...
    catch( final Exception e )
    {
      ...
      return new Status( IStatus.ERROR, KalypsoGisPlugin.getId(), 0, Messages.getString( "org.kalypso.ogc.sensor.tableview.swing.ExportableObservationTable.5" ), e ); //$NON-NLS-1$
    }
    finally
    {
