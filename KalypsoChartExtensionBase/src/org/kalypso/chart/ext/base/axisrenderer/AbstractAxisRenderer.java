...
public abstract class AbstractAxisRenderer<T_logical> implements IAxisRenderer<T_logical>
{
  ...
  protected abstract Point getTextExtent( GCWrapper gcw, T_logical value, FontData fontData, Format format );
  ...
  protected void setTickMapElement( IAxis<T_logical> axis, T_logical[] ticks )
  {
