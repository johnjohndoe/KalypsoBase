...
/**
 * @author burtscher the LegendItem is part of the legend representing 1 layer; it consists of an icon (describing the
 *         visual representation of the layer data), a name and an description;
 */
public interface ILegendItem_old
{
  ...
  /**
   * @return Point object whose x- and y-values describe the drawing space needed by the item
   */
