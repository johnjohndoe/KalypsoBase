...
import org.kalypso.chart.framework.model.event.impl.AbstractChartModelEventListener;
import org.kalypso.chart.framework.model.event.impl.AbstractMapperRegistryEventListener;
...
/**
 * Chart widget; parent for AxisComponent and Plot also acts as LayerManager and contains the AxisRegistry.
 * 
 * @author burtscher
 */
    ...
    m_mapperListener = new AbstractMapperRegistryEventListener()
    {
      ...
      public void onMapperRangeChanged( final IMapper mapper )
      {
        ...
        if( mapper instanceof IAxis )
        {
          ...
          final IChartLayer[] changedLayers = getModel().getAxis2Layers().get( axis ).toArray( new IChartLayer[] {} );
