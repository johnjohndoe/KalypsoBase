 ...
 * @author alibu
 */
public class ChartOutlinePage implements IContentOutlinePage
{
  CheckboxTableViewer m_viewer;

  private final IChartPart m_chartPart;

  public ChartOutlinePage( final IChartPart editor )
  {
    m_chartPart = editor;
  }
  ...
  public void createControl( final Composite parent )
  {
    ...
    if( m_chartPart.getChartComposite() != null )
    {
      m_viewer = new CheckboxTableViewer( new Table( parent, SWT.CHECK ) );
      ArrayContentProvider contentProvider = new ArrayContentProvider();
      m_viewer.setContentProvider( contentProvider );
      m_viewer.setLabelProvider( new ChartLabelProvider( m_chartPart ) );
      ...
      m_chartPart.getChartComposite().getModel().getLayerManager().addListener( cmel );
      ...
      ViewerDropAdapter vda = new ViewerDropAdapter( m_viewer )
      {
        ...
        public boolean performDrop( Object data )
        {
          ...
          ILayerManager lm = m_chartPart.getChartComposite().getModel().getLayerManager();
  ...
  {
    ChartComposite chartComposite = m_chartPart.getChartComposite();
    if( chartComposite != null )
    {
      ILayerManager layerManager = chartComposite.getModel().getLayerManager();
