...
public class FileCannotWriteValidator extends TypedValidator<File>
{
  ...
  public FileCannotWriteValidator( final int severity )
  {
    this( severity, DEFAULT_MESSAGE );
  }

  public FileCannotWriteValidator( final int severity, final String message )
  {
  ...
  protected IStatus doValidate( final File value ) throws CoreException
  {
    ...
    if( value.isFile() && !value.canWrite() )
      fail();
