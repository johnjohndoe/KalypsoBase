...
{
  public String DEFAULT_WARNING_MESSAGE = Messages.getString("StringEmptyValidator_0"); //$NON-NLS-1$

  public String DEFAULT_ERROR_MESSAGE = Messages.getString("StringEmptyValidator_1"); //$NON-NLS-1$
