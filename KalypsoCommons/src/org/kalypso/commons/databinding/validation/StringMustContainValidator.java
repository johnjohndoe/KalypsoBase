 ...
 */
public class StringMustContainValidator extends TypedValidator<String>
{
  private final String m_containedValue;

  public StringMustContainValidator( final int severity, final String message, final String containedValue )
  {
