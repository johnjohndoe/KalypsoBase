...
{
  private TabActionUtils( )
  {
    throw new UnsupportedOperationException();
  }

  public static void updateActions( final ToolBarManager manager, final CTabFolder folder )
  {
    ...
    for( final IContributionItem item : items )
    {
      if( item instanceof ActionContributionItem )
      {
        ...
        if( action instanceof ITabAction )
          ((ITabAction) action).update( folder );
      }
    }
  }
