 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.contribs.ogc2x;
 ...
 * @author schlienger
 */
public final class KalypsoOGC2xJAXBcontext
{
  private static JAXBContext s_context = null;

  private static Class< ? >[] s_contextClasses = { ogc2.www.opengis.net.gml.ObjectFactory.class };
