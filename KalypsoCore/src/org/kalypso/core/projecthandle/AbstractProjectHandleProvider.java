...
public abstract class AbstractProjectHandleProvider implements IProjectHandleProvder, IExecutableExtension
{
  ...
  /**
   * @see org.kalypso.core.projecthandle.IProjectHandleProvder#getID()
   */
  @Override
  public String getID( )
  {
  ...
  /**
   * @see org.kalypso.module.workspace.IProjectItemProvder#addProviderChangedListener(org.kalypso.module.workspace.IProjectItemProviderChangedListener)
   */
  @Override
