...
{
  private final ArrayContentProvider m_rootElementsProvider = new ArrayContentProvider();
  ...
  public void dispose( )
  {
    m_rootElementsProvider.dispose();
  }
  ...
  {
    return m_rootElementsProvider.getElements( inputElement );
  }
  ...
  {
    final IStatus status = statusForElement( parentElement );
  ...
  public boolean hasChildren( final Object element )
  {
    ...
    return status != null && status.isMultiStatus();
  }
