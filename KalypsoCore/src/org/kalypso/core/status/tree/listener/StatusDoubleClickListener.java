 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.core.status.tree.listener;
...
/**
 * This listener opens a status dialog.
 * 
 * @author Holger Albert
 */
public class StatusDoubleClickListener implements IDoubleClickListener
{
  /**
