...
public class SymbolizerTreeObject implements IWorkbenchAdapter, ITooltipProvider
{
   ...
   */
  public static SymbolizerTreeObject create( final RuleTreeObject parent, final Symbolizer symbolizer )
  {
  ...
  private final RuleTreeObject m_parent;

  public SymbolizerTreeObject( final RuleTreeObject parent, final Symbolizer symbolizer )
  {
    m_parent = parent;
  ...
  {
    return m_parent.resolveI18nString( label );
  }
