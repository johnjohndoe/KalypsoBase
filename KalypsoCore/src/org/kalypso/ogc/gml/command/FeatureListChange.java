 ...
 */
public class FeatureListChange extends FeatureChange
{
  /**
   * @param newValues
  ...
  {
    super( feature, listProperty, newValues );
  }
  ...
  public Object getNewValue( )
  {
    ...
    if( property != null )
    {
      ...
      featureList.clear();
      featureList.addAll( newValues );
      return featureList;
    }
    else
      return FeatureFactory.createFeatureList( feature, property, newValues );
  }
