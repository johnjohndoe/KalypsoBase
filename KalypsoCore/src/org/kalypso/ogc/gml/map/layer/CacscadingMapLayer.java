 ...
 * @author belger
 */
public class CacscadingMapLayer extends AbstractMapLayer
{
  public CacscadingMapLayer( final IMapPanel panel, final IKalypsoTheme theme )
  {
    super( panel, theme );
  }
  ...
  {
    /* If we get this request from the cascading layer, themes have been removed/addded from it. */
