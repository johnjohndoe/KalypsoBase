...
public class MapModellContextSwitcher
{
  ...
  private final class ContextSwitcherThread implements Runnable
  {
    ...
    public ContextSwitcherThread( final IContextService contextService )
    {
  ...
  private final IMapModellListener m_modelListener = new MapModellAdapter()
  {
    ...
    {
      if( source.isThemeActivated( theme ) )
