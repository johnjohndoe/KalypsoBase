...
/**
 * This kalypso theme predicate allows themes with a specific id. It is not checked, if the id is unique.
 * 
 * @author Holger Albert
 */
public class MatchingIdKalypsoThemePredicate implements IKalypsoThemePredicate
{
  /**
