...
/**
 * FIXME: @Ilya/Dimtrij: this class does not belong here
 * 
 * @author Gernot Belger
 */
class RoughnessStylePainter implements IStylePainter
{
  private final FeatureTypeStyle m_style;

  private final List<Feature> m_features;

  RoughnessStylePainter( final FeatureTypeStyle style, final List<Feature> features )
  {
    m_style = style;
    m_features = features;
  }
