...
/**
 * An axis is used to describe a 'column' of values within a Tupple Model.
 * <p>
...
public interface IAxis
{
   ...
   * observations generate new axes depending on their characteristics. For instance a WQ-ObservationFilter either
   * simulates a Q or a W axis, depending on the wrapped observation, and this simulated axis should not be saved along
   * the others (since it can be computed at any time).
   * 
   * @return boolean
   */
