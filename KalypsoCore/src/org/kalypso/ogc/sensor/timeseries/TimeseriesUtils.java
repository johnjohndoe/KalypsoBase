...
public final class TimeseriesUtils implements ITimeseriesConstants
{
  ...
  static
  {
    final String[] types = new String[] { TYPE_DATE, TYPE_EVAPORATION, TYPE_RAINFALL, TYPE_RUNOFF, TYPE_TEMPERATURE, TYPE_VOLUME, TYPE_WATERLEVEL, TYPE_NORM, TYPE_AREA, TYPE_HOURS, TYPE_NORMNULL,
        TYPE_KC, TYPE_WT, TYPE_LAI, TYPE_HUMIDITY, TYPE_VELOCITY, TYPE_MEAN_SUNSHINE_HOURS, TYPE_MEAN_WIND_VELOCITY, TYPE_MEAN_TEMPERATURE, TYPE_MEAN_HUMIDITY, TYPE_MEAN_EVAPORATION_LAND_BASED,
        TYPE_MEAN_EVAPORATION_WATER_BASED };
    Arrays.sort( types );
    TYPES_ALL = types;
  }
