 ...
 * @author Dirk Kuch
 */
public class FillEmptyAxesVisitor implements ITupleModelVisitor
{
  ...
  public FillEmptyAxesVisitor( final IAxis[] axes, final Object defaultValue )
  {
    m_axes = axes;
  ...
  {
    for( final IAxis axis : m_axes )
    {
      final Object value = container.get( axis );
      if( Objects.isNull( value ) )
        container.set( axis, m_defaultValue );
    }
  }
