...
/**
 * A {@link org.xml.sax.ContentHandler} implementation which parses GML Features.
 * 
 * This content handler delegates the parsing of any (non-feature) property-values of this feature to a {@link org.kalypso.gml.PropertyTypeHandler}s.
 * 
...
public class FeatureContentHandler extends DelegatingContentHandler implements UnmarshallResultEater, IPropertyHandler
{
  ...
  private IFeatureHandler m_featureHandler;
  ...
  private void startFeature( final QName qname, final Attributes atts ) throws SAXException
  {
    ...
    catch( InvocationTargetException e)
    {
      ...
      final IStatus status = StatusUtilities.createStatus( IStatus.WARNING, "Failed to load schema from catalog: " + qname.getNamespaceURI(), null );
