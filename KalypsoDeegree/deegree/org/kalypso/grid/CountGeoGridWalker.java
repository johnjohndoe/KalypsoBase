...
/**
 * This walker counts the number of visited cells.<br>
 * Makes only sense, if the visited cells are restricted to a certain area (i.e. a polygon).
 * 
 * @author Gernot Belger
 */
public class CountGeoGridWalker implements IGeoGridWalker
{
  private int m_count;
