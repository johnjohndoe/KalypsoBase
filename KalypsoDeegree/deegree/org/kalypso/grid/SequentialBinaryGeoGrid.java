...
/**
 * EPERIMENTAL: do not use yet!
 *
 * @author Gernot Belger
 */
public class SequentialBinaryGeoGrid extends SequentialBinaryGeoGridReader
{
  public SequentialBinaryGeoGrid( final IGeoGrid templateGrid, final URL pUrl ) throws IOException, GeoGridException
  {
    super( templateGrid, pUrl );
  }
