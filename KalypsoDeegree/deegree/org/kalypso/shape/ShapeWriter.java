...
public class ShapeWriter
{
  ...
  private void writeData( final IDBFValue[] fields, final ShapeFile shapeFile, final IProgressMonitor monitor ) throws IOException, DBaseException, SHPException, ShapeDataException
  {
    int count = 0;
