 ...
 */
class FieldFormatterBinary extends FieldFormatter
{
  public FieldFormatterBinary( )
  {
    super( null );
  }
   ...
   */
  @Override
  public byte[] toBytes( final Object value, final Charset charset )
  {
  ...
  public Object fromString( final String asString )
  {
    ...
    // FIXME: this is nonsense, please see DBF-spec
