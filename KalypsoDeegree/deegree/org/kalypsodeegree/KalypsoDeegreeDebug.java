 ...
 * @author Thomas Jung
 */
public class KalypsoDeegreeDebug
{
  public static Debug OPERATION = new Debug( KalypsoDeegreePlugin.getDefault(), "/debug/operation" );

  public static Debug GML_LOADING = new Debug( KalypsoDeegreePlugin.getDefault(), "/debug/gml_loading" ); //$NON-NLS-1$
