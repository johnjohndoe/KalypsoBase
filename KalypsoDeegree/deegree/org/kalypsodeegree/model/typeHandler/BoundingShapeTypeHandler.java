...
import org.kalypsodeegree_impl.io.sax.marshaller.BoundingShapeTypeMarshaller;
import org.kalypsodeegree_impl.io.sax.parser.BoundingShapeTypeContentHandler;
import org.xml.sax.SAXException;
import org.xml.sax.XMLReader;

/**
 * Handles elements of type gml:BoundingShapeType.
 *
 * @author Gernot Belger
 */
public class BoundingShapeTypeHandler implements IMarshallingTypeHandler2
{
  @Override
  ...
  {
    new BoundingShapeTypeMarshaller( reader ).marshall( (GM_Envelope) value );
  }
  ...
  {
    return new BoundingShapeTypeContentHandler( reader, parentContentHandler, resultEater );
  }
}