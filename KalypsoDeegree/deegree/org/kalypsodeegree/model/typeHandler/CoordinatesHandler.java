...
import org.kalypsodeegree_impl.io.sax.marshaller.PosMarshaller;
...
/**
 * A handler for gml:coordinates property.
 * 
 * @author Felipe Maximino
 *
 */
public class CoordinatesHandler implements IPropertyMarshallingTypeHandler
{
  private static QName QNAME_TYPE = GMLConstants.QN_COORDINATES;
  ...
  { 
    return new CoordinatesContentHandler( parentContentHandler, (ICoordinatesHandler) handler, defaultSrs, xmlReader );
  }
  ...
  {
    PosMarshaller marshaller = new PosMarshaller( xmlReader );
    marshaller.setPosition( ( GM_Position ) value );
    marshaller.marshall();
  }
