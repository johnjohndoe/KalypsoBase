...
public class CoordinatesHandler implements IPropertyMarshallingTypeHandler
{
  ...
  { 
    return new CoordinatesContentHandler( reader, parentContentHandler, (ICoordinatesHandler) handler, defaultSrs );
  }
  ...
  {
    final PosMarshaller marshaller = new PosMarshaller( reader );
