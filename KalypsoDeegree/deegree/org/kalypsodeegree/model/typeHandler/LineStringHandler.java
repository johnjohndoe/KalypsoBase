...
public class LineStringHandler implements IMarshallingTypeHandler2
{
  ...
  {
    return new LineStringContentHandler( reader, resultEater, parentContentHandler, KalypsoDeegreePlugin.getDefault().getCoordinateSystem() );
  }
  ...
  {
    new LineStringMarshaller( reader, (GM_Curve) value ).marshall();
  }
