 ...
 */
public class MultiCurveHandler implements IMarshallingTypeHandler2
{
  @Override
  ...
  {
    return new MultiCurveContentHandler( reader, resultEater, parentContentHandler, KalypsoDeegreePlugin.getDefault().getCoordinateSystem() );
  }
  ...
  {
    return GM_MultiCurve.MULTI_CURVE_ELEMENT.getLocalPart();
  }
