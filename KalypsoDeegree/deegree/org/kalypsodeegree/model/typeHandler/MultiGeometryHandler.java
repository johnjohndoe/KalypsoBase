...
import org.kalypsodeegree_impl.io.sax.marshaller.MultiGeometryMarshaller;
 ...
 */
public class MultiGeometryHandler implements IMarshallingTypeHandler2
{
  @Override
  ...
  {
    return new MultiGeometryContentHandler( reader, resultEater, parentContentHandler, KalypsoDeegreePlugin.getDefault().getCoordinateSystem() );
  }
  ...
  {
    new MultiGeometryMarshaller( reader, (GM_MultiGeometry) value ).marshall();
  }
  ...
  {
    return GM_MultiGeometry.MULTI_GEOMETRY_ELEMENT;
  }

  @Override
  public Class< ? > getValueClass( )
  {
    return GM_MultiGeometry.class;
  }
