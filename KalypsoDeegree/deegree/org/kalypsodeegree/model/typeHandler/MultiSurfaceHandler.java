...
public class MultiSurfaceHandler implements IMarshallingTypeHandler2
{
  ...
  {
    return new MultiSurfaceContentHandler( reader, resultEater, parentContentHandler, KalypsoDeegreePlugin.getDefault().getCoordinateSystem() );
  }
  ...
  {
    final GM_MultiSurface multi = (GM_MultiSurface) objectToClone;
    return multi.clone();
  }
  ...
  {
    new MultiSurfaceMarshaller( reader, (GM_MultiSurface) value ).marshall();
  }
