 ...
 */
public class PointHandler implements IMarshallingTypeHandler2
{
  private static final QName QNAME_TYPE = GMLConstants.QN_POINT;
  ...
  {
    return new PointContentHandler( reader, resultEater, parentContentHandler, KalypsoDeegreePlugin.getDefault().getCoordinateSystem() );
  }
