...
public class PointMemberHandler implements IPropertyMarshallingTypeHandler
{
  ...
  { 
    return new PointMemberContentHandler( parentContentHandler, (IPointHandler) handler, defaultSrs, xmlReader );
  }
  /**
  ...
  {
    PointMemberMarshaller marshaller = new PointMemberMarshaller( xmlReader );
