...
/**
 * A handler for gml:pos property.
 * 
 * @author Felipe Maximino
 *
 */
public class PosHandler implements IPropertyMarshallingTypeHandler
{
  private static QName QNAME_TYPE = GMLConstants.QN_POS;
  ...
  { 
    return new PosContentHandler( reader, parentContentHandler, (IPositionHandler) handler, defaultSrs );
  }
