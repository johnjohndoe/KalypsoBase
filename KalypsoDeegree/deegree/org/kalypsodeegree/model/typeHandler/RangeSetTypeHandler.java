...
/**
 * Handler for gml:RangeSetType from coverage.xsd.<br/>
 * TODO: For the moment, only the File element is supported.
 *
 * @author "Gernot Belger"
 */
public class RangeSetTypeHandler implements IMarshallingTypeHandler2
{
  @Override
  public Class< ? > getValueClass( )
  {
    return RangeSetFile.class;
  }

  @Override
  public QName getTypeName( )
  {
    return new QName( NS.GML3, "RangeSetType" ); //$NON-NLS-1$
  }
  ...
  public Object cloneObject( final Object objectToClone, final String gmlVersion ) throws CloneNotSupportedException
  {
    if( !(objectToClone instanceof RangeSetFile) )
      throw new CloneNotSupportedException("Value object must be of type File");

    final RangeSetFile file = (RangeSetFile) objectToClone;

    final RangeSetFile newFile = new RangeSetFile( file.getFileName() );
    newFile.setCompression( file.getCompression() );
  ...
  {
    return new RangeSetFileContentHandler( reader, resultEater, parentContentHandler );
  }
}