...
public enum PolynomialConfigState
{
  ...
  /**
   * Basically the number of the coefficients is equals to the order+1; and the last coeficient must be non null. Use
   * this value to signal that the most significant coefficient is zero
   */
  ZERO_MOST_SIGNIFICANT_COEFS,
  /**
   * The cofiguration set with order and the coefficients is consistent
   */
  CONSISTENCY_OK
