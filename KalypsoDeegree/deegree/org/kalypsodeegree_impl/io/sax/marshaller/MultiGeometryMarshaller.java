...
public class MultiGeometryMarshaller extends GeometryMarshaller<GM_MultiGeometry>
{
  ...
  @Override
  protected void doMarshallContent( final GM_MultiGeometry marshalledObject ) throws SAXException
  {
    final GeometryMemberMarshaller memberMarshaller = new GeometryMemberMarshaller( getXMLReader() );
