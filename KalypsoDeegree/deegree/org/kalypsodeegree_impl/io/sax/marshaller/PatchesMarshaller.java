...
public abstract class PatchesMarshaller<T extends GM_AbstractSurfacePatch> extends AbstractMarshaller<GM_AbstractSurface<T>>
{
  ...
  public PatchesMarshaller( final XMLReader reader, final String tag, final String defaultCRS )
  {
    super( reader, tag );

    m_defaultCRS = defaultCRS;
  }

  protected String getDefaultCRS( )
  {
    return m_defaultCRS;
  }
  ...
  protected void doMarshallContent( final GM_AbstractSurface<T> marshalledObject ) throws SAXException
  {
    ...
    for( final T patch : marshalledObject )
      surfacePatchMarshaller.marshall( patch );
  }

  protected abstract SurfacePatchMarshaller<T> createPatchMarshaller( );
}
