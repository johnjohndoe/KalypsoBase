 ...
 */
public class PositionMarshaller extends AbstractMarshaller<GM_Position>
{
  public final static String TAG_POS = "pos";
  
  private GM_Position m_position;  

  public PositionMarshaller( XMLReader xmlReader )
  {
  ...
  { 
    ...
    final double[] asArray = m_position.getAsArray();
