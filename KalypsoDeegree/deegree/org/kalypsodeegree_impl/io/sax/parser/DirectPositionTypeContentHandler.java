 ...
 */
public class DirectPositionTypeContentHandler extends GMLElementContentHandler
{
  ...
  public DirectPositionTypeContentHandler( final XMLReader reader, final IGmlContentHandler parent, final IPositionHandler positionHandler, final String defaultSrs, final String tagName )
  {
    super( reader, NS.GML3, tagName, defaultSrs, parent );
