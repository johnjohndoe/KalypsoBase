...
{  
  ...
  private List<GM_Curve> m_lineStrings;

  private GM_MultiCurve m_multiLineString;
  
  public MultiLineStringContentHandler( final UnmarshallResultEater resultEater, final ContentHandler parentContenthandler, final XMLReader xmlReader )
  {
    super( NS.GML3, ELEMENT_MULTI_LINE_STRING, xmlReader, parentContenthandler );
  ...
  {
    GM_MultiCurve lineString = endMultiLineString();
  ...
  protected void doStartElement( String uri, String localName, String name, Attributes atts )
  {
    ...
    setDelegate( new LineStringMemberContentHandler( m_xmlReader, this, m_activeSrs ) );
  }
  ...
  public void handleUnexpectedStartElement( String uri, String localName, String name, Attributes atts ) throws SAXException
  {
    ...
    {
      ContentHandler delegateHandler = new LineStringMemberContentHandler( m_xmlReader, this, m_activeSrs );
   ...
   */
  @Override
  public void handle( GM_Curve element )
  {
  ...
  {
    GM_Curve[] lineStringsArr = m_lineStrings.toArray( new GM_Curve[m_lineStrings.size()] );
