...
import org.kalypsodeegree.model.typeHandler.PosListHandler;
...
public class LineStringSpecification implements IGeometrySpecification
{
  ...
  { 
    ...
    /* gml:posList */
    specs.registerSpecificationForGeometry( new PosListHandler() );
    /* gml:coordinates for gml:LineString is deprecated with GML Version 3.1.0 */
    specs.registerSpecificationForGeometry( new CoordinatesHandler() );
    /* gml:coord for gml:LinearString is deprecated with GML Version 3.0 */
