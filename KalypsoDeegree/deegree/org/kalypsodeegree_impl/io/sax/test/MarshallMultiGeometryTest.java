 ...
 */
public class MarshallMultiGeometryTest
{
  ...
  public MarshallMultiGeometryTest( )
  {
  }
  ...
  public void testMultiCurve1( ) throws Exception
  {
    ...
    final GM_MultiGeometry toWrite = GeometryFactory.createGM_MultiGeometry( new GM_Object[] { point1, curve1 }, "EPSG:31467" ); //$NON-NLS-1$
  ...
  private String marshallMultiGeometry( final GM_MultiGeometry geometry ) throws Exception
  {
