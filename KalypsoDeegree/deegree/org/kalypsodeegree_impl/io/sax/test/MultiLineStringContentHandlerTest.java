...
public class MultiLineStringContentHandlerTest extends TestCase
{
  ...
  private void assertMultiLineString( final GM_MultiCurve multiLineString, final int expectedSize )
  {
    if( expectedSize > 0 )
    {
      final GM_Curve lineStringGot = multiLineString.getAllCurves()[0];
  ...
  private GM_MultiCurve parseMultiLineString( final String source ) throws Exception
  {
    ...
    final MultiLineStringContentHandler contentHandler = new MultiLineStringContentHandler( reader, resultEater, null, null );
