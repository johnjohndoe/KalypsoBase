 ...
 * The references are used to present the user with a choice which reference to use (e.g. a ComboBox of links).<br/>
 * Different strategy implementations can lead to different choices.
 * 
