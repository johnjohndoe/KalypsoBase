...
public class MaxExclusiveRule implements IRule
{
  ...
  public MaxExclusiveRule( final Number checkagainst )
  {
    super();
  ...
  {
    Status status = new Status( IStatus.CANCEL, Platform.PI_RUNTIME, IStatus.CANCEL, "Wert muss kleiner " + m_checkagainst.toString() + " sein.", null );

    /* If the object does not exist or is no number, return true. */
    if( object == null || !(object instanceof Number) )
      return new Status( IStatus.OK, Platform.PI_RUNTIME, IStatus.OK, "MaxExclusiveRule: Validation OK (null).", null );
    ...
    {
      status = new Status( IStatus.OK, Platform.PI_RUNTIME, IStatus.OK, "MaxExclusiveRule: Validation OK.", null );
    }
