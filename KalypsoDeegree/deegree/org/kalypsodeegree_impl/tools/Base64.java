...
public final class Base64
{
   ...
   */
  public static byte[] decodeByteArray( final byte[] base64Data )
  {
   ...
   * @return Array containing decoded data.
   */
  public static String decodeString( final byte[] base64Data )
  {
   ...
   * @return Array containing decoded data.
   */
  public static InputStream decodeInputStream( final byte[] base64Data )
  {
   ...
   * @return Array containing decoded data.
   */
  public static OutputStream decodeOutputStream( final byte[] base64Data )
  {
    final byte[] b = decodeByteArray( base64Data );
    final ByteArrayOutputStream bos = new ByteArrayOutputStream( b.length );
   ...
   * @return Array containing decoded data.
   */
  public static BufferedImage decodeImage( final byte[] base64Data ) throws IOException
  {
    final byte[] b = decodeByteArray( base64Data );
    final SeekableStream fss = new ByteArraySeekableStream( b );
    final RenderedOp ro = JAI.create( "stream", fss );
    final BufferedImage img = ro.getAsBufferedImage();
    fss.close();
    return img;
  }
}