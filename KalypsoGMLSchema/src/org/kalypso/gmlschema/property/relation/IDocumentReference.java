...
/**
 * Reference to an external document from a reference type. Used to parse app-info elements.
 * 
...
public interface IDocumentReference
{
  ...
  /**
   * The reference (url or uri) to the document. If {@link #SELF_REFERENCE} is returned, the document of the current
   * scope is meant.
   */
