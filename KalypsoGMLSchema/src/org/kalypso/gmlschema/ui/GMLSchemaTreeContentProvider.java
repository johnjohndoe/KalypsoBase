...
public class GMLSchemaTreeContentProvider implements ITreeContentProvider
{
  ...
  private final Hashtable<GMLSchema, GMLSchema> m_importMap = new Hashtable<>();
  ...
  public Object[] getChildren( final Object parent )
  {
    ...
    if( parent instanceof GMLSchema )
    {
      ...
      final List<GMLSchema> schemasToShow = new ArrayList<>();
    ...
    if( parent instanceof IRelationType )
    {
      ...
      final TreeSet<IFeatureType> sortedFTs = new TreeSet<>( new Comparator<IFeatureType>()
      {
        @Override
