...
{
  static final IFieldProvider DEFAULT_PROVIDER = new IFieldProvider()
  {
    @Override
  ...
  public FieldLabelProvider( final IFieldProvider provider )
  {
    m_provider = provider;
  }

  protected IDBFField getField( final Object element )
  {
