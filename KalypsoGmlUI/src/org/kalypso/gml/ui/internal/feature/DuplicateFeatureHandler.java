 ...
 */
public class DuplicateFeatureHandler extends AbstractHandler
{
  @Override
  public Object execute( final ExecutionEvent event ) throws ExecutionException
  {
    ...
    catch( final Exception e )
    {
      ...
      ErrorDialog.openError( shell, title, Messages.getString( "org.kalypso.ui.editor.actions.FeatureListElementDuplicateActionDelegate.1" ), status ); //$NON-NLS-1$
    }
