 ...
 */
public class DBFFieldLengthValidator implements IValidator
{
  private final DBFFieldBean m_field;

  public DBFFieldLengthValidator( final DBFFieldBean field )
  {
    m_field = field.copy();
  }
  ...
  public IStatus validate( final Object value )
  {
    ...
    try
    {
      m_field.setLength( ((Number) value).shortValue() );
