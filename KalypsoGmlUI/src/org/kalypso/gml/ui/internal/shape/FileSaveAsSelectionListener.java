...
public class FileSaveAsSelectionListener implements SelectionListener
{
  ...
  private final IObservableValue m_pathValue;

  public FileSaveAsSelectionListener( final IObservableValue pathValue, final String dialogTitle )
  {
    Assert.isTrue( pathValue.getValueType() == IPath.class );
  ...
  private void handleButtonPressed( final SelectionEvent e )
  {
    ...
    final IFile initialSelection = getInitialSelection();
    ...
    if( result != null )
      m_pathValue.setValue( result );
  }

  private IFile getInitialSelection( )
  {
    final IPath currentValue = (IPath) m_pathValue.getValue();
    if( currentValue == null )
      return null;

    final IWorkspace workspace = ResourcesPlugin.getWorkspace();
    final IWorkspaceRoot root = workspace.getRoot();
    return root.getFile( currentValue );
  }
}
