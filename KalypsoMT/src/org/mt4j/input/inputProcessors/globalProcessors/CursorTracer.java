...
/**
 * The Class CursorTracer. A global input processor tracking all AbstractCursorInputEvt events and displays a circle at
 * that position.
 * 
...
public class CursorTracer extends AbstractGlobalInputProcessor
{
   ...
   *          the current scene
   */
  public CursorTracer( AbstractMTApplication mtApp, Iscene currentScene, MTMouseInput mtMouseInput )
  {
    this.app = mtApp;
    this.scene = currentScene;
    this.cursorIDToDisplayShape = new HashMap<InputCursor, AbstractShape>();
    this.m_mouse = mtMouseInput;
...
// }
   ...
   * (non-Javadoc)
   * @see
   * org.mt4j.input.inputProcessors.globalProcessors.AbstractGlobalInputProcessor#processInputEvtImpl(org.mt4j.input
   * .inputData.MTInputEvent)
   */
  @Override
...
//          if( cursorIDToDisplayShape.size() == 1 )
//          {
//            m_mouse.fakeMousePress( position );
//          }
//          else
//          {
...
//          if( cursorIDToDisplayShape.size() == 1 )
//          {
//            m_mouse.fakeMouseMove( position );
//          }
...
//          if( cursorIDToDisplayShape.isEmpty() )
//          {
//            m_mouse.fakeMouseRelease( position );
//          }
  ...
  {
    return overlayGroup.getAttachedCamera();
  }
}
