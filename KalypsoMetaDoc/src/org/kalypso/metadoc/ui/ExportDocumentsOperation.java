...
final class ExportDocumentsOperation extends WorkspaceModifyOperation
{
  ...
  private final PublishingConfiguration m_configuration;

  private final IExportTarget m_target;

  ExportDocumentsOperation( final IExportableObjectFactory factory, final PublishingConfiguration configuration, final IExportTarget target )
  {
    m_factory = factory;
