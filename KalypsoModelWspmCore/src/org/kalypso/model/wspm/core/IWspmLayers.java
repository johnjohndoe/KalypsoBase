...
public interface IWspmLayers
{
  ...
  String THEME_GELAENDE = PROFILE_LAYER + "GELAENDE"; //$NON-NLS-1$

  String LAYER_GELAENDE = PROFILE_LAYER + "GELAENDE_POINTS"; //$NON-NLS-1$
  ...
  String LAYER_STATION_LINES = PROFILE_LAYER + "STATION_LINES"; //$NON-NLS-1$
}
