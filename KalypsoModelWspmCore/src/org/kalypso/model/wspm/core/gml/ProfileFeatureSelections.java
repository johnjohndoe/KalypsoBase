...
public final class ProfileFeatureSelections
{
  ...
  public static IProfileFeature findFeature( final IStructuredSelection selection )
  {
  ...
  private static IProfileFeature toProfileFeature( final Object element )
  {
    if( element instanceof IProfileFeature )
      return (IProfileFeature) element;

    if( element instanceof IAdaptable )
      return (IProfileFeature) ((IAdaptable) element).getAdapter( IProfileFeature.class );
