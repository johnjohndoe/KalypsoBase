 ...
 * @author Dirk Kuch
 */
abstract class AbstractClassificationClass extends Feature_Impl implements IClassificationClass
{
  ...
  public String formatValue( final String label, final String format, final BigDecimal value )
  {
    if( value == null )
