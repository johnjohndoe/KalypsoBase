 ...
 * @author Dirk Kuch
 */
public class FillMissingProfileGeometriesManipulator implements IProfileManipulator
{
  private final boolean m_extrapolate;

  public FillMissingProfileGeometriesManipulator( final boolean extrapolate )
  {
