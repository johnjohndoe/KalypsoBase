...
//
// assertEquals( "neue Brücke:", IWspmTuhhConstants.BUILDING_TYP_BRUECKE , p.getBuilding().getTyp() );
...
// change.doChange( null );
// assertEquals( "Überfallbeiwert:", 0.123,
// p.getDevider(IWspmTuhhConstants.MARKER_TYP_WEHR)[0].getValueFor(DEVIDER_PROPERTY.BEIWERT) );
