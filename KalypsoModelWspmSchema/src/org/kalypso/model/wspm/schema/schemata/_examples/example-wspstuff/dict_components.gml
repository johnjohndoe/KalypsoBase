...
<gml:Dictionary xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
     ...
     <gml:description>Ein Dictionary f�r die Modellierung von L�ngsschnitten</gml:description>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="h_BV">
               <gml:name>Bordvoll H�he</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="Boe_li">
               <gml:name>B�schung (links)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="Boe_re">
               <gml:name>B�schung (rechts)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="f_li">
               <gml:name>Fl�che (links)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="f_fl">
               <gml:name>Fl�che (Flussschlauch)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="f_re">
               <gml:name>Fl�che (rechts)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="BrueckOK">
               <gml:name>Br�cke (Oberkante)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="BrueckUK">
               <gml:name>Br�cke (Unterkante)</gml:name>
               <swe:property>
     ...
     <gml:dictionaryEntry>
          <swe:ItemDefinition gml:id="BrueckB">
               <gml:name>Br�cke (Breite in Flie�richtung)</gml:name>
               <swe:property>
