 ...
 */
public class ShowProfileHandler extends AbstractHandler
{
  @Override
  public Object execute( final ExecutionEvent event ) throws ExecutionException
  {
    ...
    final IWorkbenchWindow activeWindow = HandlerUtil.getActiveWorkbenchWindowChecked( event );
    ...
    {
      ErrorDialog.openError( shell, Messages.getString( "org.kalypso.model.wspm.ui.action.ShowProfileAction.0" ), Messages.getString( "org.kalypso.model.wspm.ui.action.ShowProfileAction.1" ), e.getStatus() ); //$NON-NLS-1$ //$NON-NLS-2$
      return null;
    }
  }
}
