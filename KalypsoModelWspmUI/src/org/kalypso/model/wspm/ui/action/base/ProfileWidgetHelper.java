 ...
 */
public class ProfileWidgetHelper
{
  private ProfileWidgetHelper( )
  {
  }

  public static IProfileFeature[] getProfiles( final ISelection selection )
  {
  ...
  private static IProfileFeature[] resovleProfiles( final EasyFeatureWrapper[] features )
  {
  ...
  /**
   * This function returns true, if the point lies near (&lt; 0.001) a coordinate of the geometry.
   * 
   * @param geometry
   *          The geometry.
   * @param point
   *          The point to check.
   * @return True, if the point lies near (&lt; 0.001) a coordinate of the geometry.
   */
  public static boolean isVertexPoint( final Geometry geometry, final Coordinate point )
  {
