...
public class ProfileProviderAdapterFactory implements IAdapterFactory
{
  ...
  private final IPartListener2 m_partAdapter = new PartAdapter2()
  {
    /**
    ...
    if( adapterType == IProfilProvider.class )
      if( adaptableObject instanceof IWorkbenchPart )
      {
        ...
        synchronized( m_providers )
        {
          ...
          final FeatureSelectionProfileProvider featureSelectionProfileProvider = new FeatureSelectionProfileProvider( selectionProvider );
