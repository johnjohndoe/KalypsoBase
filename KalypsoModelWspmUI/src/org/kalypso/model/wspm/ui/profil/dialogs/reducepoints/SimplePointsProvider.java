...
public class SimplePointsProvider implements IPointsProvider
{
  ...
  public SimplePointsProvider( final IProfileRecord[] points )
  {
    m_points = points;
  }
  ...
  {
    return Messages.getString( "org.kalypso.model.wspm.ui.view.table.DouglasPeuckerActionDelegate.2" ); //$NON-NLS-1$
  }
}