...
import org.kalypso.module.welcome.actions.CreateProjectAction;
...
public abstract class AbstractKalypsoModule implements IKalypsoModule, IExecutableExtension
{
  ...
  public IAction[] getProjectActions( )
  {
    ...
    {
      final String createProjectLabel = Messages.getString( "CreateProjectAction.1" ); //$NON-NLS-1$
      final CreateProjectAction createProjectAction = new CreateProjectAction( createProjectLabel, newProjectWizard );
    ...
    {
      final String demoProjectLabel = Messages.getString( "CreateProjectAction.2" ); //$NON-NLS-1$
      final CreateProjectAction demoProjectAction = new CreateProjectAction( demoProjectLabel, demoProjectWizard );
  ...
  /**
   * Returns <code>null</code> by default, intended to be overwritten.
   */
  @Override
