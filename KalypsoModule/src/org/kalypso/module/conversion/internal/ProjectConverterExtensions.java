 ...
 */
public final class ProjectConverterExtensions
{
  private static final String NAMESPACE = Module.PLUGIN_ID;

  private static final String PROJECT_CONVERSION_EXTENSION = "conversion"; //$NON-NLS-1$
  ...
  public static IProjectConverterFactory[] getProjectConverter( final String moduleID )
  {
    ...
    {
      if( CONVERSION_POINT.equals( element.getName() ) )
      {
