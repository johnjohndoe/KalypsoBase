...
/**
 * @deprecated Grrr, nothing is never disposed....!
 */
@Deprecated
public class MyFonts
{
  ...
  static public final Font WELCOME_PAGE_LIST_HEADER = new Font( Display.getDefault(), "Tahoma", 10, SWT.BOLD ); //$NON-NLS-1$

  static public final Font MENU_HEADING = new Font( Display.getDefault(), "Tahoma", 8, SWT.BOLD ); //$NON-NLS-1$
