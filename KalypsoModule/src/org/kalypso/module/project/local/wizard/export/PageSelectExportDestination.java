...
public class PageSelectExportDestination extends WizardPage
{
  ...
  public PageSelectExportDestination( )
  {
    ...
    setTitle( Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.0" ) ); //$NON-NLS-1$
    setDescription( Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.1" ) ); //$NON-NLS-1$
  }
  ...
  public void createControl( final Composite parent )
  {
    ...
    group.setText( Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.2" ) ); //$NON-NLS-1$
    ...
    final String target = Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.3", javaTmpDir ); //$NON-NLS-1$
    m_sFile = target;
    text.setText( target );
  ...
  protected void checkPage( )
  {
    ...
    {
      setMessage( Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.4" ), IMessageProvider.ERROR ); //$NON-NLS-1$
    ...
    if( file.exists() )
    {
      setMessage( Messages.getString( "org.kalypso.core.projecthandle.local.exportwizard.PageSelectExportDestination.5" ), IMessageProvider.WARNING ); //$NON-NLS-1$
