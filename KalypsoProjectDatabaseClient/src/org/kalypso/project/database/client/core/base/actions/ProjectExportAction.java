...
public class ProjectExportAction implements IProjectAction
{
  ...
  public ProjectExportAction( final ILocalProject handler, final IProjectDatabaseUiLocker locker )
  {
    m_handler = handler;
    m_locker = locker;
  }
    ...
    link.addHyperlinkListener( new HyperlinkAdapter()
    {
      ...
      public void linkActivated( final HyperlinkEvent e )
      {
        try
        {
          ...
          final WizardProjectExport wizard = new WizardProjectExport( m_handler.getProject() );
          wizard.init( PlatformUI.getWorkbench(), new StructuredSelection( m_handler.getProject() ) );
