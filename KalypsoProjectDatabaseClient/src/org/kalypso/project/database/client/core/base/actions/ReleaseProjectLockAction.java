 ...
 * @author Dirk Kuch
 */
public class ReleaseProjectLockAction extends Action
{
  private static final ImageDescriptor IMG_RELEASE_LOCK = ImageDescriptor.createFromURL( ReleaseProjectLockAction.class.getResource( "images/action_lock_release.gif" ) ); //$NON-NLS-1$

  protected final ITranscendenceProject m_handler;

  protected final IKalypsoModule m_module;

  public ReleaseProjectLockAction( final ITranscendenceProject handler, final IKalypsoModule module )
  {
    m_handler = handler;
    m_module = module;

    setImageDescriptor( IMG_RELEASE_LOCK );
