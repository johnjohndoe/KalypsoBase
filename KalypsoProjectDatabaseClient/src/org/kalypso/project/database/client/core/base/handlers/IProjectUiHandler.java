...
public interface IProjectUiHandler
{
   ...
   * open the project
   */
  IProjectAction getOpenAction( );

  /**
   * info about the project
   */
  IProjectAction getInfoAction( );

  /**
   * sets project editable
   */
  IProjectAction getEditAction( );

  /**
   * delete action for project
   */
  IProjectAction getDeleteAction( );

  /**
   * model database action
   */
  IProjectAction getDatabaseAction( );
