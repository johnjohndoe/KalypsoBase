...
class RemoteProjectRowBuilder extends AbstractProjectRowBuilder
{
  ...
  public RemoteProjectRowBuilder( final IRemoteProject remote, final IKalypsoModule module, final IProjectDatabaseUiLocker locker )
  {
    super( module, locker );
    m_remote = remote;
  }
  ...
  public void render( final Composite parent, final FormToolkit toolkit )
  {
    ...
    lnk.setText( m_remote.getName() );

    /* info */
    RemoteProjectHelper.getRemoteInfoLink( m_remote, body, toolkit, getLocker() );
