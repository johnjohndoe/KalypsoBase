...
/**
 * This repository item represents a simple repository item, which can be added at any point in the repository structure
 * for UI purposes.
 * 
 * @author Holger Albert
 */
public class SimpleRepositoryItem implements IRepositoryItem
{
  /**
   * The name.
   */
