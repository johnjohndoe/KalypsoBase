...
public class ImageOutput
{
  ...
  public static void imageResponse( RequestBean request, ResponseBean response, ImageData id )
  {
    ...
    if( imgTypeStr != null && !imgTypeStr.toLowerCase().equals( "png" ) )
    {
      ...
      else if( imgTypeStr.toLowerCase().equals( "gif" ) )
      {
        ...
        // Versucht, das mit einem TreeSet zu machen, aber da kommt eine ClassCastException, weil RGB nicht Comparable
        // implementiert
