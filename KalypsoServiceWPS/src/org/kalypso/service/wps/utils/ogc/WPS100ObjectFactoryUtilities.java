...
import net.opengis.wps._1_0.ComplexDataCombinationsType;
import net.opengis.wps._1_0.ComplexDataDescriptionType;
...
import net.opengis.wps._1_0.DocumentOutputDefinitionType;
import net.opengis.wps._1_0.Execute;
import net.opengis.wps._1_0.InputDescriptionType;
...
/**
 * Utility functions for complying to the OGC WPS 1.0.0 standard.
 * 
 * @author Holger Albert
 */
public class WPS100ObjectFactoryUtilities
{
  /**
   * Factory for WPS Objects.
   */
  private final static net.opengis.wps._1_0.ObjectFactory WPS_1_0_0_OF = new net.opengis.wps._1_0.ObjectFactory();

  /**
   * Factory for OWS Objects.
   */
  private final static net.opengis.ows._1.ObjectFactory OWS_1_0_0_OF = new net.opengis.ows._1.ObjectFactory();

  /**
   * The constructor.
   */
  private WPS100ObjectFactoryUtilities( )
  {
  }
  ...
  public static InputReferenceType buildComplexValueReference( final String reference, final String format, final String encoding, final String schema )
  {
    ...
    if( format != null )
      complexValueReference.setMimeType( format );
  ...
  public static ComplexDataType buildComplexValueType( final String format, final String encoding, final String schema, final List<Object> value )
  {
    ...
    /* Attributes. */
    if( format != null )
      complexValue.setMimeType( format );
  ...
  public static InputType buildIOValueType( final CodeType identifier, final LanguageStringType title, final LanguageStringType abstrakt, final Object valueFormChoice )
  {
    ...
    if( valueFormChoice instanceof InputReferenceType )
      ioValue.setReference( (InputReferenceType) valueFormChoice );
    else if( valueFormChoice instanceof DataType )
      ioValue.setData( (DataType) valueFormChoice );
  ...
  public static OutputDescriptionType buildOutputDefinitionType( final CodeType identifier, final LanguageStringType title, final LanguageStringType abstrakt, final String format, final String encoding, final String schema )
  {
    ...
    if( format != null )
      complexDataDescription.setMimeType( format );
  ...
  public static DescribeProcess buildDescribeProcess( final List<CodeType> identifier )
  {
    ...
    describeProcess.setVersion( WPSUtilities.WPS_VERSION.V100.toString() );
