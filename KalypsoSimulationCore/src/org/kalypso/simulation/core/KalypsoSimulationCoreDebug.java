...
{
  public static Debug SIMULATION_SERVICE = new Debug( KalypsoSimulationCorePlugin.getDefault(), "/debug/simulation/service" ); //$NON-NLS-1$

  public static Debug KEEP_SIMULATION_FILES = new Debug( KalypsoSimulationCorePlugin.getDefault(), "/debug/keepSimulationFiles" ); //$NON-NLS-1$
}
