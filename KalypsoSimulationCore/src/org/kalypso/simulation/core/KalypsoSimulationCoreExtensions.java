...
//        element.getAttribute( "id" );
        ...
        Logger.getLogger( KalypsoSimulationCoreExtensions.class.getName() ).warning( "<" + EXT_ATTRIB_CATALOGCLASS + "> attribute is not defined. Cannot load corresponding UrlCatalog: " + element.getValue() );
    }
