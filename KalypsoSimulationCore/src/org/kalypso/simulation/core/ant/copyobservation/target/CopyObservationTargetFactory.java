...
public final class CopyObservationTargetFactory
{
  ...
  private static ICopyObservationTarget getLink( final URL context, final File targetObservationDir, final DateRange targetRange, final DateRange forecastRange )
  {
    return new CopyObservationNATarget( context, targetObservationDir, targetRange, forecastRange );
  }

  private static ICopyObservationTarget getLink( final URL context, final GMLXPath hrefTargetObservation, final DateRange targetRange, final DateRange forecastRange )
  {
