...
public final class SimulationFactory
{
  ...
  public static IStatus runCalculation( final IContainer calcCaseFolder, final IProgressMonitor monitor, final Modeldata modelspec ) throws CoreException
  {
    ...
    {
      e.printStackTrace();
      final IStatus error = new Status( IStatus.ERROR, KalypsoSimulationCorePlugin.getID(), "Unexpected error during simulation", e.getTargetException() );
  ...
  public static ISimulationRunner createSimulationRunner( final IContainer calcCaseFolder, final Modeldata modelspec ) throws CoreException
  {
    final ISimulationRunner runner = createRunner();
    runner.init( calcCaseFolder, modelspec );
    return runner;
  }

  private static ISimulationRunner createRunner( ) throws CoreException
  {
  ...
  {
    return System.getProperty( "org.kalypso.service.wps.service" );
  }
}