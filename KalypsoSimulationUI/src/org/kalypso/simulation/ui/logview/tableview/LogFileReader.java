/*--------------- Kalypso-Header --------------------------------------------------------------------
 ...
 ---------------------------------------------------------------------------------------------------*/
package org.kalypso.simulation.ui.logview.tableview;
...
{
  private Vector<LogFileRow> rows = new Vector<LogFileRow>();

  FileReader idMap = null;

  BufferedReader br = null;

  public LogFileReader( IFile file )
  {
    File logFile = file.getRawLocation().toFile();
    GMLWorkspace logWorkspace = null;
    try
    {
      logWorkspace = GmlSerializer.createGMLWorkspace( logFile.toURL(), null );
    }
