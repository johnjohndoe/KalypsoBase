...
public class CreateCalcCasePage extends WizardPage implements ICalcWizardPage
{
  ...
  public void createControl( final Composite parent )
  {
    ...
    // while creation of the coices, an invisible choice may validate itself,
    // causing the errorMessgage and so on to be set wrongly
    if( m_choice != null )
  ...
  {
    // TODO: give a href to the common description
    return null;
  }
}