...
public class ObservationMapTableDiagWizardPage extends AbstractCalcWizardPage
{
  ...
  /**
   * Argument: Basisname der Zeitreihen-Properties. Es kann mehrere Zeitreihen geben-Property geben: eine f?r jede
   * Kurventyp.
   */
  ...
  public void createControl( final Composite parent )
  {
    ...
    catch( final Throwable e )
    {
      ...
      else
      {
        ...
        status = StatusUtilities.statusFromThrowable( e, localizedMessage == null ? "" : localizedMessage );
      }
  ...
  private void createRightPanel( final SashForm sashForm ) throws NumberFormatException
  {
    ...
    initDiagram( rightSash ).setLayoutData( new GridData( GridData.FILL_BOTH ) );
