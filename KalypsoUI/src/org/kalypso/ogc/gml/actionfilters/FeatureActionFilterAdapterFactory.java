 ...
 * @author schlienger
 */
public class FeatureActionFilterAdapterFactory implements IAdapterFactory
{
  private final ActionFilterRegistry m_featureActionFilter;

  public FeatureActionFilterAdapterFactory( )
  {
    m_featureActionFilter = new ActionFilterRegistry( Feature.class.getName() );
  }
