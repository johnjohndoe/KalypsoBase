 ...
 */
public class LabelFeatureControl extends AbstractFeatureControl
{
  private final String m_text;

  public LabelFeatureControl( final Feature feature, final IPropertyType ftp, final String text )
  {
    super( feature, ftp );
    m_text = text;
  }
