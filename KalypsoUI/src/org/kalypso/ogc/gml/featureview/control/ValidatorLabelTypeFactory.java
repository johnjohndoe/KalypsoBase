 ...
 *
 */
public class ValidatorLabelTypeFactory implements IFeatureControlFactory
{
  /**
  ...
  {
    final boolean showOk = parentComposite.isShowOk();
    return new ValidatorFeatureControl( feature, pt, showOk );
  }
}
