 ...
 */
public class CompositeFeatureControlFactory implements IFeatureCompositionControlFactory
{
  private final CompositeType m_compositeType;

  public CompositeFeatureControlFactory( final CompositeType compositeType )
  {
  ...
  {
    return new CompositeFeatureControl( featureComposite, m_compositeType, annotation, translator );
  }
}
