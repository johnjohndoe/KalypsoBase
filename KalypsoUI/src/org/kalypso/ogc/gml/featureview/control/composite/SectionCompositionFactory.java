 ...
 */
public class SectionCompositionFactory implements IFeatureCompositionControlFactory
{
  private final Section m_sectionType;

  public SectionCompositionFactory( final Section sectionType )
  {
  ...
  {
    return new SectionCompositionControl( m_sectionType, featureComposite, annotation, translator );
  }
}