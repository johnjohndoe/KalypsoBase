...
public interface IFeatureviewFactory
{
   ...
   */
  FeatureviewTypeWithContext get( IFeatureType featureType, Feature feature );
   ...
   */
  ITranslator getDefaultTranslator( );
   ...
   * @see #getDefaultTranslator()
   */
  void setDefaultTranslator( ITranslator translator );
}
