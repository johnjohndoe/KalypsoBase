 ...
 * @author kuepfer
 */
public class FeaturePropertyLabelProvider extends LabelProvider
{
  /**
  ...
  public String getText( final Object element )
  {
    ...
    if( GeometryUtilities.isMultiPolygonGeometry( element ) )
      return "MultiPolygon"; //$NON-NLS-1$
    if( GeometryUtilities.isPointGeometry( element ) )
      return "Point"; //$NON-NLS-1$
    if( GeometryUtilities.isMultiPointGeometry( element ) )
