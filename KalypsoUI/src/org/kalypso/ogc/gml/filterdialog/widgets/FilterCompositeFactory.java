    ...
    if( operation != null )
    {
      ...
      if( operation instanceof PropertyIsCOMPOperation )
      {
        if( operatorName == null )
          operatorName = Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.0"); //$NON-NLS-1$
        ((Group) parent).setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.1") + operatorName ); //$NON-NLS-1$
      ...
      {
        if( operatorName == null )
          operatorName = Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.2"); //$NON-NLS-1$
        ((Group) parent).setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.3") + operatorName ); //$NON-NLS-1$
      ...
      {
        if( operatorName == null )
          operatorName = Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.4"); //$NON-NLS-1$
        ((Group) parent).setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.5") + operatorName ); //$NON-NLS-1$
      ...
      {
        if( operatorName == null )
          operatorName = Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.6"); //$NON-NLS-1$
        ((Group) parent).setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.7") + operatorName ); //$NON-NLS-1$
      ...
      {
        if( operatorName == null )
          operatorName = Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.8"); //$NON-NLS-1$
        ((Group) parent).setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.FilterCompositeFactory.9") + operatorName ); //$NON-NLS-1$
