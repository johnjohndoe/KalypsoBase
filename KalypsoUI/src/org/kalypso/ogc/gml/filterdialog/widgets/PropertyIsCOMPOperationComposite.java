...
class PropertyIsCOMPOperationComposite extends AbstractFilterComposite
{
  ...
  private void setControl( )
  {
    ...
    m_supportedOpsLable.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsCOMPOperationComposite.0") ); //$NON-NLS-1$
    ...
    m_firstRowLabel.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsCOMPOperationComposite.1") ); //$NON-NLS-1$
    ...
    m_secondRowLabel.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsCOMPOperationComposite.2") ); //$NON-NLS-1$
