...
class PropertyIsLikeOperationComposite extends AbstractFilterComposite
{
  ...
  private void setControl( )
  {
    ...
    parameterGroup.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsLikeOperationComposite.0") ); //$NON-NLS-1$
    m_wildCardLabel = new Label( parameterGroup, SWT.NONE );
    m_wildCardLabel.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsLikeOperationComposite.1") ); //$NON-NLS-1$
    ...
    m_singleCharLabel.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsLikeOperationComposite.2") ); //$NON-NLS-1$
    ...
    m_escpapeCharLabel.setText( Messages.get("org.kalypso.ogc.gml.filterdialog.widgets.PropertyIsLikeOperationComposite.3") ); //$NON-NLS-1$
