...
/**
 * Handler for displaying doubles.
 * 
 * @author Gernot Belger
 */
public class XsdDoubleGuiTypeHandler extends XsdBaseGuiTypeHandler
{
  /**
   * @param handler
   *          The base type handler.
   */
  public XsdDoubleGuiTypeHandler( final XsdBaseTypeHandler< ? > handler )
  {
    super( handler );
  }
