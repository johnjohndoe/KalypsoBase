...
public class KalypsoWMSTheme extends AbstractKalypsoTheme implements ITooltipProvider
{
  ...
  {
    Assert.isTrue( element == this, Messages.get( "org.kalypso.ogc.gml.map.themes.KalypsoWMSTheme.19" ) ); //$NON-NLS-1$
...
// }
    ...
    getFeatureInfoResultProcessor.write( Messages.get( "org.kalypso.ogc.gml.map.themes.KalypsoWMSTheme.21" ) ); //$NON-NLS-1$
  }
