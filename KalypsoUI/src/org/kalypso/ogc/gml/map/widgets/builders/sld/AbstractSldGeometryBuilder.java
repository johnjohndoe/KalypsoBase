...
public abstract class AbstractSldGeometryBuilder implements ISldGeometryBuilder
{
  ...
  public AbstractSldGeometryBuilder( final IMapPanel panel, URL... slds )
  {
    ...
    {
      final URL urlLine = AbstractSldGeometryBuilder.class.getResource( "resources/default.line.sld" ); //$NON-NLS-1$
      final URL urlPolygon = AbstractSldGeometryBuilder.class.getResource( "resources/default.polygon.sld" ); //$NON-NLS-1$
