...
public class SelectFeaturesMapFunction implements IRectangleMapFunction
{
   ...
   *          The provider of the features (e.g. {@link org.kalypso.ogc.gml.map.widgets.providers.QNameFeaturesProvider} ).
   * @param selectionChanger
   *          The selection changer is responsible for really changing the selection in a specific way (e.g. {@link org.kalypso.ogc.gml.map.widgets.changers.SingleSelectionChanger}).
   * @param manager
  ...
  /**
   * @see org.kalypso.informdss.manager.util.widgets.IRectangleMapFunction#execute(org.kalypso.ogc.gml.map.MapPanel, org.eclipse.swt.graphics.Rectangle)
   */
  @Override
  ...
  protected IFeatureSelectionManager getSelectionManager( )
  {
    return m_manager;
  }

  protected IFeatureSelectionChanger getSelectionChanger( )
  {
