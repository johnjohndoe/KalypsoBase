...
public class NodeFactory
{
  ...
  {
    final IThemeNode[] childNodes = new IThemeNode[elements.length];
    for( int i = 0; i < elements.length; i++ )
      childNodes[i] = NodeFactory.createNode( parent, elements[i] );

    return childNodes;
  }

  public static IThemeNode createRootNode( final Object element, final TreeViewer viewer )
  {
