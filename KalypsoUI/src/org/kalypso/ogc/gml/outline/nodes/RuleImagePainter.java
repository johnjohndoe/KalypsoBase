 ...
 */
class RuleImagePainter
{
  private final Rule m_rule;

  RuleImagePainter( final Rule rule )
  {
    m_rule = rule;
  }

  public void paintImage( final GC gc ) throws Exception
  {
    final Feature feature = Symbolizer_Impl.createPseudoFeature();

    final LegendGraphic legendGraphic = m_rule.getLegendGraphic();
