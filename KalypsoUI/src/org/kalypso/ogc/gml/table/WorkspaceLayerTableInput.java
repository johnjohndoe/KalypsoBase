...
import org.kalypso.ogc.gml.WorkspaceFeaturesProvider;
 ...
 */
public class WorkspaceLayerTableInput implements ILayerTableInput
{
  ...
  public WorkspaceLayerTableInput( final CommandableWorkspace workspace, final String featurePath, final ICommandTarget commandTarget )
  {
    m_workspace = workspace;
    m_commandTarget = commandTarget;

    m_featuresProvider = new WorkspaceFeaturesProvider( workspace, featurePath );
  }
