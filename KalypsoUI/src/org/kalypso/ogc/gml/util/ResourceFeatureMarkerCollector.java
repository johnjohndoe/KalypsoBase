...
public class ResourceFeatureMarkerCollector implements IFeatureMarkerCollector
{
  ...
  {
    final String debugMsg = String.format( Messages.get("org.kalypso.ogc.gml.util.ResourceFeatureMarkerCollector.0"), feature.getId(), property == null ? "null" //$NON-NLS-1$ //$NON-NLS-2$
