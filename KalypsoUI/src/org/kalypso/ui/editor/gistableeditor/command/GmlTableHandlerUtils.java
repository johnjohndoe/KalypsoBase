 ...
 *
 *  ---------------------------------------------------------------------------*/
package org.kalypso.ui.editor.gistableeditor.command;

import org.eclipse.core.commands.ExecutionEvent;
import org.eclipse.core.commands.ExecutionException;
import org.eclipse.core.expressions.IEvaluationContext;
import org.kalypso.ogc.gml.table.LayerTableViewer;
import org.kalypso.ui.editor.gistableeditor.GmlTableSourceProvider;
...
public class GmlTableHandlerUtils
{
   ...
   *           If the current context contains no tree.
   */
  public static LayerTableViewer getTableViewerChecked( final IEvaluationContext context ) throws ExecutionException
  {
    final LayerTableViewer tableViewer = getTableViewer( context );
    if( tableViewer == null )
      throw new ExecutionException( "No table in context." ); //$NON-NLS-1$
