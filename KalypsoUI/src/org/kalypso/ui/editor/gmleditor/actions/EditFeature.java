  ...
  public void run( IAction action )
  {
   if( m_selection!= null && action.isEnabled() )
   {
     ...
     catch( final PartInitException e )
     {
       ...
       ErrorDialog.openError( shell, Messages.getString("org.kalypso.ui.editor.gmleditor.actions.EditFeature.1"), Messages.getString("org.kalypso.ui.editor.gmleditor.actions.EditFeature.2"), e.getStatus() ); //$NON-NLS-1$ //$NON-NLS-2$
     }
   }
