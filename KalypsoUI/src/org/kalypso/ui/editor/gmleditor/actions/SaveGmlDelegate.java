...
public class SaveGmlDelegate extends AbstractGisEditorActionDelegate
{
  ...
  public void run( final IAction action )
  {
    ...
    if( !MessageDialog.openConfirm( shell, Messages.getString( "org.kalypso.ui.editor.gmleditor.actions.SaveGmlDelegate.0" ), Messages.getString( "org.kalypso.ui.editor.gmleditor.actions.SaveGmlDelegate.1" ) ) ) //$NON-NLS-1$ //$NON-NLS-2$
      return;
