 ...
 */
public class GmltreeHandlerUtils
{
  private GmltreeHandlerUtils( )
  {
   ...
   * 
   * @return <code>null</code>, if no {@link org.kalypso.ui.editor.gmleditor.part.GmlTreeView} was found in the context.
   */
   ...
   *           If the current context contains no tree.
   */
  public static GmlTreeView getTreeViewerChecked( final IEvaluationContext context ) throws ExecutionException
  {
    final GmlTreeView treeViewer = getTreeViewer( context );
    if( treeViewer == null )
      throw new ExecutionException( "No tree in context." ); //$NON-NLS-1$
