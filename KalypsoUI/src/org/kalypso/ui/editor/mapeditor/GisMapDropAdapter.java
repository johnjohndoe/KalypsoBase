...
class GisMapDropAdapter extends ViewerDropAdapter
{
  ...
  GisMapDropAdapter( final Viewer viewer, final ICommandTarget commandTarget, final IKalypsoLayerModell mapModell )
  {
    super( viewer );
  ...
  public boolean performDrop( final Object data )
  {
    ...
    final GisMapOutlineDropData dropData = new GisMapOutlineDropData( m_mapModell, 0 );
