 ...
 */
public class GisMapEditorActionBarContributor extends AbstractEditorActionBarContributor
{
  private ShowDescriptionStatusLineItem m_statusLineItem;

  @Override
  protected void handleEditorSelectionChanged( final ISelectionProvider selectionProvider )
  {
  }
