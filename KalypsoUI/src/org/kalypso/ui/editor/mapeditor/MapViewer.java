...
/**
 * Helper that simulaties a Viewer on top of a map part. Necessary for drop support.<br/>
...
class MapViewer extends Viewer
{
  ...
  public MapViewer( final Composite control, final ISelectionProvider selectionProvider )
  {
    m_control = control;
