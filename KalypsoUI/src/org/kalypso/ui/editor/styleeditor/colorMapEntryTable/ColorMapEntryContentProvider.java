 ...
 */
public class ColorMapEntryContentProvider implements IStructuredContentProvider, IColorMapEntryViewer
{
  /**
   * The viewer.
   */
   ...
   * The input.
   */
  private ColorMapEntryList m_input;

  /**
   * The constructor.
   */
  public ColorMapEntryContentProvider( )
  {
    m_viewer = null;
    m_input = null;
  }
  ...
  public void inputChanged( Viewer viewer, Object oldInput, Object newInput )
  {
    ...
    if( m_input != null )
    {
      m_input.removeChangeListener( this );
      m_input = null;
    }
  ...
  public Object[] getElements( Object parent )
  {
    ...
    return m_input.getColorMapEntries().toArray();
  }
