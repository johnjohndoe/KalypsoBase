 ...
 */
public class GraphicRotationField extends InputWithContextObservableValue<Graphic, Integer>
{
  public GraphicRotationField( final IStyleInput<Graphic> input )
  {
   ...
   */
  @Override
  protected Integer getValueFromData( final Graphic data )
  {
    try
    {
  ...
  public void configureSpinner( final Spinner control )
  {
    control.setMinimum( 0 );
    control.setMaximum( 359 );
    control.setDigits( 0 );
    control.setIncrement( 1 );
    control.setPageIncrement( 45 );
  }
}