 ...
 */
public class MarkStrokeAddAction extends StyleElementAction<Mark>
{
  public MarkStrokeAddAction( final IStyleInput<Mark> input )
  {
    super( input );

    setText( Messages.getString( "MarkStrokeAddAction_0" ) ); //$NON-NLS-1$
