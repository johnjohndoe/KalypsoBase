 ...
 */
public class HaloRadiusValue extends InputWithContextObservableValue<Halo, Double>
{
  public HaloRadiusValue( final IStyleInput<Halo> input )
  {
    super( input, Double.class );
  }

  @Override
  protected Double getValueFromData( final Halo data )
  {
    try
    {
      return data.getRadius( null );
    }
   ...
   */
  @Override
  protected void setValueToInput( final Halo data, final Double value )
  {
    if( value == null )
      data.setRadius( null );
    else
      data.setRadius( value );
  }
