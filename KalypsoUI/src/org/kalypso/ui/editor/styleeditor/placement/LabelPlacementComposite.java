...
public class LabelPlacementComposite extends Composite
{
  ...
  private String createContents( )
  {
    ...
    {
      final IStyleInput<PointPlacement> placementInput = new StyleInput<>( m_pointPlacement, m_input );
    ...
    {
      final IStyleInput<LinePlacement> placementInput = new StyleInput<>( m_linePlacement, m_input );
