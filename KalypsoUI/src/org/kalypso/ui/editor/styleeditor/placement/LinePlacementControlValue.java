 ...
 */
public class LinePlacementControlValue extends InputWithContextObservableValue<LinePlacement, PlacementType>
{
  public LinePlacementControlValue( final IStyleInput<LinePlacement> input )
  {
    super( input, PlacementType.class );
  }

  @Override
  protected PlacementType getValueFromData( final LinePlacement data )
  {
    try
    {
      return data.getPlacementType( null );
    }
   ...
   */
  @Override
  protected void setValueToInput( final LinePlacement data, final PlacementType value )
  {
    data.setPlacementType( value );
  }
