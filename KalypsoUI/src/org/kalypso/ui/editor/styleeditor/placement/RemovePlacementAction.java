 ...
 */
public class RemovePlacementAction extends StyleElementAction<TextSymbolizer>
{
  public RemovePlacementAction( final IStyleInput<TextSymbolizer> input )
  {
    super( input );
  ...
  protected boolean checkEnabled( final TextSymbolizer data )
  {
    ...
    final PointPlacement pointPlacement = placement.getPointPlacement();
    final LinePlacement linePlacement = placement.getLinePlacement();

    return pointPlacement != null || linePlacement != null;
  }
  ...
  protected void changeElement( final TextSymbolizer data )
  {
    ...
    placement.setPointPlacement( null );
    placement.setLinePlacement( null );
  }
}