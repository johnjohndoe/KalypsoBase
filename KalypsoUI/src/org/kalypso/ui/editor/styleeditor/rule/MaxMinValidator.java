 ...
 */
public class MaxMinValidator extends TypedValidator<BigDecimal>
{
  private final IStyleInput<Rule> m_input;

  public MaxMinValidator( final IStyleInput<Rule> input )
  {
    super( BigDecimal.class, IStatus.ERROR, MessageBundle.STYLE_EDITOR_ERROR_MAX_DENOM_SMALL );
  ...
  protected IStatus doValidate( final BigDecimal value ) throws CoreException
  {
    ...
    final double min = m_input.getData().getMinScaleDenominator();
