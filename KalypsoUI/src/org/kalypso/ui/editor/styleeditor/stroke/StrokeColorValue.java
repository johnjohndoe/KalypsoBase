...
{
  public StrokeColorValue( final IStyleInput<Stroke> input )
  {
    super( input, Color.class );
  }

  @Override
  protected Color getValueFromData( final Stroke data )
  {
    try
    {
  ...
  @Override
  protected void setValueToInput( final Stroke data, final Color value )
  {
    data.setStroke( value );
  }
}