 ...
 */
public class StrokeDashOffsetValue extends InputWithContextObservableValue<Stroke, Float>
{
  public StrokeDashOffsetValue( final IStyleInput<Stroke> input )
  {
    super( input, Float.class );
  }

  @Override
  protected Float getValueFromData( final Stroke data )
  {
    try
    {
      return data.getDashOffset( null );
    }
  ...
  {
    if( value == null )
      data.setDashOffset( 0f );
    else
      data.setDashOffset( value );
  }
}