 ...
 */
public final class RuleTabUtils
{
  private RuleTabUtils( )
  {
    throw new UnsupportedOperationException();
  }

  public static IPropertyType[] getNumericProperties( final IFeatureType featureType )
  {
    final Collection<IPropertyType> result = new ArrayList<IPropertyType>();
