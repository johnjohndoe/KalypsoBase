 ...
 */
public class GraphicRemoveAction extends StyleElementAction<PointSymbolizer>
{
  public GraphicRemoveAction( final IStyleInput<PointSymbolizer> input )
  {
    super( input );

    setText( Messages.getString( "GraphicRemoveAction_0" ) ); //$NON-NLS-1$
