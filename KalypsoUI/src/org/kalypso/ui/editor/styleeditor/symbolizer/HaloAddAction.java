 ...
 */
public class HaloAddAction extends StyleElementAction<TextSymbolizer>
{
  public HaloAddAction( final IStyleInput<TextSymbolizer> input )
  {
    super( input );
  ...
  {
    data.setHalo( StyleFactory.createHalo() );
  }
}