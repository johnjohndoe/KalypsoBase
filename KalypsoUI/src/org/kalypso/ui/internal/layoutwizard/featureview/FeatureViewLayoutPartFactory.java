...
/**
 * The feature view layout part factory.
 * 
 * @author Holger Albert
 */
public class FeatureViewLayoutPartFactory implements ILayoutPartFactory
{
  @Override
  public ILayoutPart createLayoutPart( final String id, final ILayoutPageContext context )
  {
    return new FeatureViewLayoutPart( id, context );
  }
}