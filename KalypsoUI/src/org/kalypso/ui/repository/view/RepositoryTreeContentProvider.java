...
public class RepositoryTreeContentProvider implements ITreeContentProvider
{
  ...
  public Object[] getChildren( final Object parentElement )
  {
    ...
    {
      e.printStackTrace();
      MessageDialog.openError( PlatformUI.getWorkbench().getDisplay().getActiveShell(), Messages.get( "org.kalypso.ui.repository.view.RepositoryTreeContentProvider.0" ), e.getLocalizedMessage() ); //$NON-NLS-1$
  ...
  public Object getParent( final Object element )
  {
    ...
    {
      e.printStackTrace();
      MessageDialog.openError( PlatformUI.getWorkbench().getDisplay().getActiveShell(), Messages.get( "org.kalypso.ui.repository.view.RepositoryTreeContentProvider.1" ), e.getLocalizedMessage() ); //$NON-NLS-1$
  ...
  public boolean hasChildren( final Object element )
  {
    ...
    {
      e.printStackTrace();
      MessageDialog.openError( PlatformUI.getWorkbench().getDisplay().getActiveShell(), Messages.get( "org.kalypso.ui.repository.view.RepositoryTreeContentProvider.2" ), e.getLocalizedMessage() ); //$NON-NLS-1$
