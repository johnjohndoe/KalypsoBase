 ...
 */
public class SelectShapeFilePage extends WizardPage
{
  ...
  protected void checkPageComplete( )
  {
    ...
    {
      setMessage( "W‰hlen Sie ein Shape aus...", ERROR );
    ...
    {
      setMessage( "W‰hlen Sie das Koordinaten-System des Shapes aus...", ERROR );
      setPageComplete( false );
      return;
    }
  }
