...
public class LegendUtilities
{
  ...
  /**
   * This constant defines the theme property, used to configure the border width of the legend.
   */
  public static final String THEME_PROPERTY_BORDER_WIDTH = "border_width";
