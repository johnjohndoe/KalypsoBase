 ...
 * @author Dirk Kuch
 */
public final class ZmlSourceElements
{
  private ZmlSourceElements( )
  {
  ...
  private static String getType( final String identifier )
  {
    ...
    if( StringUtils.containsIgnoreCase( identifier, ITimeseriesConstants.TYPE_POLDER_CONTROL ) ) //$NON-NLS-1$
    ...
    final RETokenizer tokenizer = new RETokenizer( new Pattern( "_.*" ), identifier ); //$NON-NLS-1$
