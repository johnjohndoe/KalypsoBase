...
{
  private final Set<IZmlSourceElement> m_sources = new LinkedHashSet<>();
  ...
  {
    return m_sources.toArray( new IZmlSourceElement[] {} );
  }

  @Override
  public void add( final IZmlSourceElement soure )
  {
    m_sources.add( soure );
  }
