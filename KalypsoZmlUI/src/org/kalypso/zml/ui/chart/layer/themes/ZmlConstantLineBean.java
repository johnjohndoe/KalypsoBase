 ...
 * @author kimwerner
 */
public class ZmlConstantLineBean
{
  ...
  public ZmlConstantLineBean( final String label, final Number value, final ILineStyle lineStyle, final ITextStyle textStyle, final boolean showLabel )
  {
    m_label = label;
    m_value = value;
