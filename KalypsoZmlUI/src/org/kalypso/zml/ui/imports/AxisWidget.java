...
public class AxisWidget extends Composite
{
  ...
  private void createControl( )
  {
    ...
    group.setText( Messages.getString( "org.kalypso.zml.ui.imports.AxisWidget.0" ) ); //$NON-NLS-1$

    group.setLayoutData( new GridData( SWT.FILL, SWT.FILL, true, false ) );

    final Label labelName = new Label( group, SWT.NONE );
    labelName.setText( Messages.getString( "org.kalypso.zml.ui.imports.AxisWidget.1" ) ); //$NON-NLS-1$
    labelName.setLayoutData( new GridData( SWT.END, SWT.CENTER, false, false ) );

    m_textName = new Text( group, SWT.BORDER );
    m_textName.setText( Messages.getString( "org.kalypso.zml.ui.imports.AxisWidget.2" ) ); //$NON-NLS-1$
    m_textName.setLayoutData( new GridData( SWT.FILL, SWT.CENTER, true, false ) );

    final Label labelType = new Label( group, SWT.NONE );
    labelType.setText( Messages.getString( "org.kalypso.zml.ui.imports.AxisWidget.3" ) ); //$NON-NLS-1$
