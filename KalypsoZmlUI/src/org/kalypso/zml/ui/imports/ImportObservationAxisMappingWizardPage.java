...
public class ImportObservationAxisMappingWizardPage extends WizardPage implements ISelectionChangedListener
{
  ...
  public ImportObservationAxisMappingWizardPage( final String pageName )
  {
    ...
    setTitle( Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationWizard.2" ) ); //$NON-NLS-1$
  ...
  public void createControl( final Composite parent )
  {
    ...
    labelSource.setText( Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationAxisMappingWizardPage.1" ) ); //$NON-NLS-1$
    ...
    labelTarget.setText( Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationAxisMappingWizardPage.2" ) ); //$NON-NLS-1$
  ...
  public void selectionChanged( final SelectionChangedEvent event )
  {
    ...
    final String axisTypeValue = m_nativeAdapter.getAxisTypeValue();

    final IAxis[] axisSrc = m_nativeAdapter.createAxis( axisTypeValue );
    ...
    if( m_fileTarget != null && m_fileTarget.exists() )
    {
      ...
      {
        MessageDialog.openInformation( getShell(), Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationAxisMappingWizardPage.3" ), //$NON-NLS-1$
            Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationAxisMappingWizardPage.4" ) ); //$NON-NLS-1$
      }
    }
