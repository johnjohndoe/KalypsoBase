...
public class ImportObservationWizard extends Wizard implements IImportWizard
{
  ...
  public ImportObservationWizard( )
  {
    ...
    setWindowTitle( Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationWizard.0" ) ); //$NON-NLS-1$
  }
  ...
  public void init( final IWorkbench workbench, final IStructuredSelection currentSelection )
  {
    ...
    setWindowTitle( Messages.getString( "org.kalypso.zml.ui.imports.ImportObservationWizard.1" ) ); //$NON-NLS-1$
