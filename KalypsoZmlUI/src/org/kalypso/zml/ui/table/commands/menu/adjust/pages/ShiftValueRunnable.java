 ...
 * @author Dirk Kuch
 */
public class ShiftValueRunnable extends AbstractValueRunnable
{

  private final Double m_shiftValue;

  public ShiftValueRunnable( final IZmlModelValueCell[] cells, final Double shiftValue )
  {
    super( cells );
  ...
  {
    return value.doubleValue() + m_shiftValue;
  }
