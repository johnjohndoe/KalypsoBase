...
public class ZmlEinzelwertModel
{
  ...
  Set<IZmlEinzelwertModelListener> m_listeners = new LinkedHashSet<>();

  Set<ZmlEinzelwert> m_rows = new TreeSet<>( new Comparator<ZmlEinzelwert>()
  {
    @Override
  ...
  {
    final Map<Date, ZmlEinzelwert> map = new HashMap<>();
  ...
  {
    final Set<Date> existing = new TreeSet<>();
