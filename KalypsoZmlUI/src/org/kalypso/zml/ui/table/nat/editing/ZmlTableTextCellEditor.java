 ...
 * @author Dirk Kuch
 */
public class ZmlTableTextCellEditor extends TextCellEditor implements IZmlTableCellEditor
{

  private final ZmlModelViewport m_viewport;

  public ZmlTableTextCellEditor( final ZmlModelViewport viewport )
  {
    m_viewport = viewport;
  }
