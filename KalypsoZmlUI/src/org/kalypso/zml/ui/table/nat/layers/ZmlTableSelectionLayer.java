...
public class ZmlTableSelectionLayer extends SelectionLayer implements IZmlTableSelection
{
  ...
  {
    final Set<IZmlModelColumn> selection = new LinkedHashSet<>();
  ...
  {
    final Set<IZmlModelRow> selection = new TreeSet<>( IZmlModelRow.COMPARATOR );
  ...
  {
    final Set<IZmlModelCell> selection = new LinkedHashSet<>();
