...
public class ZmlColumnHeaderCellPainter extends AbstractZmlCellPainter
{
  ...
  public void paintCell( final LayerCell cell, final GC gc, final Rectangle bounds, final IConfigRegistry configRegistry )
  {
    ...
    if( object instanceof IZmlModelColumn )
    {
      ...
      final ICellPainter painter = new TextPainter( isWrapped( cell ), true, true )
      {
        @Override
        protected String getTextToDisplay( final LayerCell c, final GC gcc, final int availableLength, final String text )
        {
          return text;
        }
      };
