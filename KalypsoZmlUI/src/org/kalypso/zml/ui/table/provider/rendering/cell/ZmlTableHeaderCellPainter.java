 ...
 * @author Dirk Kuch
 */
public class ZmlTableHeaderCellPainter extends AbstractZmlTableCellPainter
{

  private Point m_ptr;

  public ZmlTableHeaderCellPainter( final IZmlTableHeaderCell cell )
  {
    super( cell );
  }

  @Override
  public IZmlTableHeaderCell getCell( )
  {
    return (IZmlTableHeaderCell) super.getCell();
  }
...
// return ptr;
  ...
  private static final Font FONT = new Font( null, "Arial", 10, SWT.BOLD );

  private static final Color FOREGROUND = new Color( null, 0, 0, 0 );
