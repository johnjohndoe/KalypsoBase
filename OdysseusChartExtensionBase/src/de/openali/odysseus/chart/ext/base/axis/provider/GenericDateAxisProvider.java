...
import de.openali.odysseus.chart.ext.base.axis.DateAxis;
 ...
 * @author alibu
 */
public class GenericDateAxisProvider extends AbstractAxisProvider
{
  /**
  ...
  {
    return new DateAxis( getId(), POSITION.BOTTOM );
  }
