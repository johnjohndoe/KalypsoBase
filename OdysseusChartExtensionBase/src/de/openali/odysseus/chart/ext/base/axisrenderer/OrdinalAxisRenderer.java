...
public class OrdinalAxisRenderer extends ExtendedAxisRenderer
{
  ...
  {
    this( id, config, tickLabelRenderer, null, contentProvider,minWidth,maxWidth  );
  }
  ...
  {
    this( id, config, null, null, contentProvider,minWidth,maxWidth  );
  }

  public OrdinalAxisRenderer( final String id, final AxisRendererConfig config,final int minWidth, final int maxWidth )
  {
    this( id, config, null, null,minWidth,maxWidth );
  }
