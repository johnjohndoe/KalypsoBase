 ...
 * @author kimwerner
 */
public class OrdinalAxisRenderer_obsolete implements IAxisRenderer
{
  ...
  public OrdinalAxisRenderer_obsolete( final String id, final AxisRendererConfig config, final IChartLabelRenderer tickLabelRenderer, final IChartLabelRenderer axisTitleRenderer, final IAxisContentProvider contentProvider )
  {
  ...
  public OrdinalAxisRenderer_obsolete( final String id, final AxisRendererConfig config, final IChartLabelRenderer tickLabelRenderer, final IAxisContentProvider contentProvider )
  {
    this( id, config, tickLabelRenderer, null, contentProvider );
  }

  public OrdinalAxisRenderer_obsolete( final String id, final AxisRendererConfig config, final IAxisContentProvider contentProvider )
  {
    this( id, config, null, null, contentProvider );
  }

  public OrdinalAxisRenderer_obsolete( final String id, final AxisRendererConfig config )
  {
