...
public class CalendarAxis extends AbstractAxis<Calendar>
{
  ...
  public Point logicalToScreenInterval( Calendar value, Calendar fixedPoint, double intervalSize )
  {
    ...
    Logger.logInfo( Logger.TOPIC_LOG_AXIS, "Axis (" + getIdentifier() + "): starting IntervalCalculation" );
    ...
    Logger.logInfo( Logger.TOPIC_LOG_AXIS, "Axis (" + getIdentifier() + "): IntervalCalculation finished" );
    ...
    Logger.logInfo( Logger.TOPIC_LOG_AXIS, "Axis (" + getIdentifier() + "): Using Interval: " + startPoint + ":" + endPoint );
