...
import org.kalypso.chart.ext.base.axis.GenericLinearAxis;
...
public class GenericLinearAxisProvider extends AbstractAxisProvider
{
  ...
  {
    final GenericLinearAxis axis = new GenericLinearAxis( getId(), getLabel(), getPosition(), getDirection(), getValueArray(), getDataClass() );
    if( axis != null )
      axis.setNumericRange( getRange( axis ) );
    else
