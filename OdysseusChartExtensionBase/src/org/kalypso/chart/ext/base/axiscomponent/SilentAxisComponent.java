 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.chart.ext.base.axiscomponent;
 ...
 * 
 */
public class SilentAxisComponent implements IAxisComponent
{
  ...
  /**
   * @see org.kalypso.chart.framework.model.mapper.component.IAxisComponent#dispose()
   */
  public void dispose( )
  {
  ...
  /**
   * @see org.kalypso.chart.framework.model.mapper.component.IAxisComponent#setVisible(boolean)
   */
