 ...
 * @author Dirk Kuch
 */
public class ExtendedReferenceResolver implements IReferenceResolver
{

  private final IReferenceResolver m_resolver;

  public ExtendedReferenceResolver( final IReferenceResolver resolver )
  {
    m_resolver = resolver;
  }
  ...
  {
    final Object reference = m_resolver.resolveReference( id );
    if( reference != null )
    {
      return reference;
    }
    ...
    return resolver.resolveReference( id );
  }
