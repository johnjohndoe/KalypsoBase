...
public final class Providers
{
  ...
  public static void updateParameter( final ProviderType provider, final String property, final String value )
  {
    final ParametersType parameters = provider.getParameters();
    final ParameterType[] parameterTypes = parameters.getParameterArray();
