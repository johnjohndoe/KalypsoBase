...
public class TextStyle extends AbstractStyle implements ITextStyle
{
   ...
   * (non-Javadoc)
   * 
   * @see de.openali.odysseus.chart.framework.impl.model.style.ITextStyle#setWeight(de.openali.odysseus.chart.framework.model
   ...
   * (non-Javadoc)
   * 
   * @see de.openali.odysseus.chart.framework.impl.model.style.ITextStyle#setStyle(de.openali.odysseus.chart.framework.model
