...
/**
 * @author burtscher static helper methods to ease the handling of
 *         Style-concerns
 */
public class StyleUtils
{
	...
	/**
	 * transforms an array of points into an array of alternating x- and y-
	 * values
	 */
	...
	{
		return new PointStyle(getDefaultLineStyle(), IDefaultStyles.DEFAULT_WIDTH, IDefaultStyles.DEFAULT_HEIGHT, IDefaultStyles.DEFAULT_ALPHA, IDefaultStyles.DEFAULT_RGB_BACKGROUND, IDefaultStyles.DEFAULT_MARKER, IDefaultStyles.DEFAULT_VISIBILITY);
	}

	public static IAreaStyle getDefaultAreaStyle()
	{
		return new AreaStyle(getDefaultLineStyle(), IDefaultStyles.DEFAULT_FILL, IDefaultStyles.DEFAULT_ALPHA, getDefaultLineStyle(), IDefaultStyles.DEFAULT_VISIBILITY);
	}
