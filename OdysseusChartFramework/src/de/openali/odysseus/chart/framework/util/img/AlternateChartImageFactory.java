...
/**
 * Creates an Image from a chart widget. The objects has to be disposed when
 * it's no longer needed This alternate version demonstrates that chart images
 * can be created without cut tick values
 * 
 * @author burtscher
 */
