...
/**
 * Collects a visible layers and returns them in reverse order, suitable for painting.
 *
 * @author Gernot Belger
 */
public class PaintableLayersVisitor implements IChartLayerVisitor2
{
  ...
  public boolean visit( final IChartLayer layer ) throws CancelVisitorException
  {
    ...
    /* sub layers of invisible layers are not painted */
