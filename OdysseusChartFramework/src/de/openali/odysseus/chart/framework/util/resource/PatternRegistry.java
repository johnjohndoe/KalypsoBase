...
// }
   ...
   */
  @Override
  protected Pair<Image, Pattern> createResource( Device dev, ImageDescriptor descriptor )
  {
    Image img = descriptor.createImage( dev );
    Pattern p = new Pattern( dev, img );
    Pair pair = new Pair<Image, Pattern>( img, p );
    return pair;
  }
   ...
   */
  @Override
  protected void disposeResource( Pair<Image, Pattern> resource )
  {
