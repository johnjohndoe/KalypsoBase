...
public class InvalidateChartImageCompositeJob extends Job
{
  ...
  public InvalidateChartImageCompositeJob( final ChartImageComposite chart )
  {
  ...
  public void setPanel( final Rectangle panel )
  {
    m_panel = panel;
  }
  ...
  protected IStatus run( final IProgressMonitor monitor )
  {
    ...
    m_chart.doInvalidateChart( m_panel );

    return Status.OK_STATUS;
  }

  public void reschedule( final Rectangle panel )
  {
    cancel();
