package org.kalypso.chart.framework.impl.model.data;
...
public class DataRange<T> implements IDataRange<T>
{
  ...
  public DataRange( final T min, final T max ) throws ZeroSizeDataRangeException
  {
    ...
    /*
     * das w�re dann der ung�nstigste Fall: nicht vergleichbar und nicht numerisch TODO: �berlegen, ob dieser Fall
