package org.kalypso.chart.framework.impl.model.mapper.registry;
...
import org.kalypso.chart.framework.impl.model.event.AbstractMapperEventListener;
import org.kalypso.chart.framework.impl.model.event.MapperRegistryEventHandler;
...
public class MapperRegistry implements IMapperRegistry
{
  ...
  public void addMapper( IMapper< ? , ? > mapper )
  {
    ...
    else
    {
      ...
      {
        /**
         * @see org.kalypso.chart.framework.impl.model.event.AbstractMapperEventListener#onMapperRangeChanged(org.kalypso.chart.framework.model.mapper.IMapper)
         */
        @Override
