...
public class GetSymbol extends AbstractODSOperation
{
  ...
  public void execute( ) throws OWSException
  {
    ...
    // TODO: Hier sollte noch sichergestellt werden, dass Scene, Chart, Layer und Symbol-ID auch vorhanden sind
    ...
    ImageData id = ODSUtils.loadSymbol( getEnv().getTmpDir(), sceneId, chartId, layerId, symbolId );
