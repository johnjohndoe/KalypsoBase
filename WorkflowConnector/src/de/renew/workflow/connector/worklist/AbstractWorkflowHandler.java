...
public abstract class AbstractWorkflowHandler extends AbstractHandler implements IWorklistChangeListener, IExecutableExtension
{
  ...
  {
    WorkflowConnectorPlugin.getDefault().getConnector().addWorklistChangeListener( this );
  }
  ...
  public void dispose( )
  {
    WorkflowConnectorPlugin.getDefault().getConnector().removeWorklistChangeListener( this );
    super.dispose();
  }
