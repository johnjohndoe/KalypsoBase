...
rem ---------------------------------------------------------------------------
rem Script for enabling Callback 
rem
...
rem Invoking CallbackController
"%JAVA_HOME%\bin\java.exe" -Djava.endorsed.dirs="%JWSDP_HOME%\jaxp\lib;%JWSDP_HOME%\jaxp\lib\endorsed" -classpath %JWSDP_HOME%\jwsdp-shared\webapps\jwsdp-callback\WEB-INF\classes;%PRG%\..;%PATH% com.sun.jwsdp.callback.CallbackController true 
