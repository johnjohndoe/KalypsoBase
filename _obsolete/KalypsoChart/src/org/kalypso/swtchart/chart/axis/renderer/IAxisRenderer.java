...
public interface IAxisRenderer<T>
{
   ...
   */
  public Collection<T> getGridTicks( IAxis<T> axis );
   ...
   */
  public void paint( GCWrapper gc, IAxis<T> axis, Rectangle screenArea );
  ...
  /**
   * Calculates the maximum size of an axis label
   */
 // public Point calcTickLabelSize( GCWrapper gc, final IAxis<T> axis );
}
