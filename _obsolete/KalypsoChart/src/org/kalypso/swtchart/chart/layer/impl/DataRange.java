...
public class DataRange<T> implements IDataRange<T>
{
  ...
  /**
   * @see org.kalypso.swtchart.layer.IDataRange#getMin()
   */
  public T getMin( )
  {
    return m_min;
  ...
  /**
   * @see org.kalypso.swtchart.layer.IDataRange#getMax()
   */
  public T getMax( )
  {
    return m_max;
...
//  /**
//   * @see org.kalypso.swtchart.chart.layer.IDataRange#zoom(double)
//   */
