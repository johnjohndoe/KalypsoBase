...
{
  public NumberAxis( String id, String label, PROPERTY prop, POSITION pos, DIRECTION dir, Comparator<Number> comp )
  {
   ...
   */
  public Point logicalToScreenInterval( Number value, Number fixedPoint, double intervalSize )
  {
